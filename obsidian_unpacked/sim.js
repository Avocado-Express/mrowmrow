(() => {
    ...
    function r(A, t, n, i) {
        if (isNaN(t) || isNaN(n)) return A;
        var r, g, e, I, o, a, h, f, C, s = A._root,
            u = {
                data: i
            },
            l = A._x0,
            ...
            B = A._x1,
            y = A._y1;
        if (!s) return A._root = u, A;
        for (; s.length;)
            if ((a = t >= (g = (l + B) / 2)) ? l = g : B = g, (h = n >= (e = (Q + y) / 2)) ? Q = e : y = e, r = s, !(s = s[f = h << 1 | a])) return r[f] = u, A;
        if (I = +A._x.call(null, s.data), o = +A._y.call(null, s.data), t === I && n === o) return u.next = s, r ? r[f] = u : A._root = u, A;
        do {
            r = r ? r[f] = new Array(4) : A._root = new Array(4), (a = t >= (g = (l + B) / 2)) ? l = g : B = g, (h = n >= (e = (Q + y) / 2)) ? Q = e : y = e
        } while ((f = h << 1 | a) == (C = (o >= e) << 1 | I >= g));
        return r[C] = s, r[f] = u, A
    }
    ...
    f.copy = function() {
        var A, t, n = new a(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
            i = this._root;
        if (!i) return n;
        if (!i.length) return n._root = h(i), n;
        for (A = [{
                source: i,
                target: n._root = new Array(4)
            }]; i = A.pop();)
            for (var r = 0; r < 4; ++r)(t = i.source[r]) && (t.length ? A.push({
                source: t,
        ...
        var t, n, i, g, e = A.length,
            ...
            f = -1 / 0,
            C = -1 / 0;
        for (n = 0; n < e; ++n) isNaN(i = +this._x.call(null, t = A[n])) || isNaN(g = +this._y.call(null, t)) || (I[n] = i, o[n] = g, i < a && (a = i), i > f && (f = i), g < h && (h = g), g > C && (C = g));
        if (a > f || h > C) return this;
        for (this.cover(a, h).cover(f, C), n = 0; n < e; ++n) r(this, I[n], o[n], A[n]);
        return this
    }, f.cover = function(A, t) {
        if (isNaN(A = +A) || isNaN(t = +t)) return this;
        var n = this._x0,
            i = this._y0,
            r = this._x1,
            g = this._y1;
        if (isNaN(n)) r = (n = Math.floor(A)) + 1, g = (i = Math.floor(t)) + 1;
        else {
            for (var e, I, o = r - n || 1, a = this._root; n > A || A >= r || i > t || t >= g;) switch (I = (t < i) << 1 | A < n, (e = new Array(4))[I] = a, a = e, o *= 2, I) {
                case 0:
                    r = n + o, g = i + o;
                    break;
                case 1:
        ...
        var i, r, e, I, o, a, h, f = this._x0,
            C = this._y0,
            s = this._x1,
            u = this._y1,
            l = [],
            Q = this._root;
        for (Q && l.push(new g(Q, f, C, s, u)), null == n ? n = 1 / 0 : (f = A - n, C = t - n, s = A + n, u = t + n, n *= n); a = l.pop();)
            if (!(!(Q = a.node) || (r = a.x0) > s || (e = a.y0) > u || (I = a.x1) < f || (o = a.y1) < C))
                if (Q.length) {
                    var B = (r + I) / 2,
                        y = (e + o) / 2;
                    l.push(new g(Q[3], B, y, I, o), new g(Q[2], r, y, B, o), new g(Q[1], B, e, I, y), new g(Q[0], r, e, B, y)), (h = (t >= y) << 1 | A >= B) && (a = l[l.length - 1], l[l.length - 1] = l[l.length - 1 - h], l[l.length - 1 - h] = a)
                } else {
                    ...
                    if (v < n) {
                        var x = Math.sqrt(n = v);
                        f = A - x, C = t - x, s = A + x, u = t + x, i = Q.data
                    }
                } return i
    }, f.remove = function(A) {
        if (isNaN(g = +this._x.call(null, A)) || isNaN(e = +this._y.call(null, A))) return this;
        var t, n, i, r, g, e, I, o, a, h, f, C, s = this._root,
            u = this._x0,
            l = this._y0,
            Q = this._x1,
            B = this._y1;
        ...
        if (s.length)
            for (;;) {
                if ((a = g >= (I = (u + Q) / 2)) ? u = I : Q = I, (h = e >= (o = (l + B) / 2)) ? l = o : B = o, t = s, !(s = s[f = h << 1 | a])) return this;
                if (!s.length) break;
                (t[f + 1 & 3] || t[f + 2 & 3] || t[f + 3 & 3]) && (n = t, C = f)
            }
        for (; s.data !== A;)
            if (i = s, !(s = s.next)) return this;
        return (r = s.next) && delete s.next, i ? (r ? i.next = r : delete i.next, this) : t ? (r ? t[f] = r : delete t[f], (s = t[0] || t[1] || t[2] || t[3]) && s === (t[3] || t[2] || t[1] || t[0]) && !s.length && (n ? n[C] = s : this._root = s), this) : (this._root = r, this)
    }, f.removeAll = function(A) {
        for (var t = 0, n = A.length; t < n; ++t) this.remove(A[t]);
        return this
    }, f.root = function() {
        return this._root
    }, f.size = function() {
        ...
        for (a && o.push(new g(a, this._x0, this._y0, this._x1, this._y1)); t = o.pop();)
            if (!A(a = t.node, i = t.x0, r = t.y0, e = t.x1, I = t.y1) && a.length) {
                var h = (i + e) / 2,
                    f = (r + I) / 2;
                (n = a[3]) && o.push(new g(n, h, f, e, I)), (n = a[2]) && o.push(new g(n, i, f, h, I)), (n = a[1]) && o.push(new g(n, h, r, e, f)), (n = a[0]) && o.push(new g(n, i, r, h, f))
            } return this
        ...
        for (this._root && n.push(new g(this._root, this._x0, this._y0, this._x1, this._y1)); t = n.pop();) {
            ...
            if (r.length) {
                var e, I = t.x0,
                    ...
                    f = (I + a) / 2,
                    C = (o + h) / 2;
                (e = r[0]) && n.push(new g(e, I, o, f, C)), (e = r[1]) && n.push(new g(e, f, o, a, C)), (e = r[2]) && n.push(new g(e, I, C, f, h)), (e = r[3]) && n.push(new g(e, f, C, a, h))
            }
            i.push(t)
        }
        for (; t = i.pop();) A(t.node, t.x0, t.y0, t.x1, t.y1);
        return this
    }, f.x = function(A) {
    ...
    self.onmessage = function(A) {
        var t = A.data,
            n = t.nodes;
        if (n) {
            for (var i in M = [], F) F.hasOwnProperty(i) && !n.hasOwnProperty(i) ? delete F[i] : M.push(F[i]);
            for (var i in n)
    ...
    var S, p, U, _, N, q, R, k, b, J, Y, K = function() {
            try {
                if ("object" == typeof WebAssembly && "function" == typeof WebAssembly.instantiate) {
                    var A = function(A) {
                            for (var t = atob(A), n = new Uint8Array(t.length), i = 0; i < t.length; i++) n[i] = t.charCodeAt(i);
                            return n.buffer
                    ...
                    return function() {
                        ...
                        if (d || D) {
                            ...
                            for (var e = 0; e < M.length; e++) {
                                var I = M[e];
                                r[5 * e] = I.x, r[5 * e + 1] = I.y, r[5 * e + 2] = I.vx, r[5 * e + 3] = I.vy
                            }
                            for (e = 0; e < G.length; e++) {
                                var o = G[e];
                                g[3 * e] = o.source.index, g[3 * e + 1] = o.target.index
                            }
                            n.init(0, M.length, G.length)
                        }
                        n.simulate(0, M.length, G.length, Q, c, E, v, x, .9, .5), n.complete(0, M.length, .6);
            ...
            function I() {
                if (n) {
                    var A, e = n.length;
                    for (i = new Array(e), r = new Array(e), A = 0; A < e; ++A) i[A] = isNaN(r[A] = +t(n[A], A, n)) ? 0 : +g(n[A], A, n)
                }
            }
            ...
            function l(A) {
                for (var n = 0, i = r.length; n < u; ++n)
                    for (var I, o, f, C, s, l, Q, B = 0; B < i; ++B) o = (I = r[B]).source, C = (f = I.target).x + f.vx - o.x - o.vx || t(h), s = f.y + f.vy - o.y - o.vy || t(h), C *= l = ((l = Math.sqrt(C * C + s * s)) - e[B]) / l * A * g[B], s *= l, f.vx -= C * (Q = a[B]), f.vy -= s * Q, o.vx += C * (Q = 1 - Q), o.vy += s * Q
            }
            ...
            function Q() {
                if (I) {
                    var A, t, n = I.length,
                        h = r.length,
                        C = new Map(I.map(((A, t) => [f(A, t, I), A])));
                    for (A = 0, o = new Array(n); A < h; ++A)(t = r[A]).index = A, "object" != typeof t.source && (t.source = i(C, t.source)), "object" != typeof t.target && (t.target = i(C, t.target)), o[t.source.index] = (o[t.source.index] || 0) + 1, o[t.target.index] = (o[t.target.index] || 0) + 1;
                    for (A = 0, a = new Array(h); A < h; ++A) t = r[A], a[A] = o[t.source.index] / (o[t.source.index] + o[t.target.index]);
                    g = new Array(h), B(), e = new Array(h), y()
                }
            }

            function B() {
                if (I)
                    for (var A = 0, t = r.length; A < t; ++A) g[A] = +C(r[A], A, r)
            }

            function y() {
                if (I)
                    for (var A = 0, t = r.length; A < t; ++A) e[A] = +s(r[A], A, r)
            }
            ...
            function u(A) {
                var t, r = n.length,
                    e = o(n, C, s).visitAfter(Q);
                for (g = A, t = 0; t < r; ++t) i = n[t], e.visit(B)
            }

            function l() {
                if (n) {
                    var A, t, i = n.length;
                    for (e = new Array(i), A = 0; A < i; ++A) t = n[A], e[t.index] = +I(t, A, n)
                }
            }
            ...
            function Q(A) {
                var t, n, i, r, g, I = 0,
                    o = 0;
                if (A.length) {
                    for (i = r = g = 0; g < 4; ++g)(t = A[g]) && (n = Math.abs(t.value)) && (I += t.value, o += n, i += n * t.x, r += n * t.y);
                    A.x = i / o, A.y = r / o
                } else {
                    (t = A).x = t.data.x, t.y = t.data.y;
                    do {
                        I += e[t.data.index]
                    } while (t = t.next)
                }
            ...
            function B(A, n, I, o) {
                ...
                var C = A.x - i.x,
                    ...
                    u = o - n,
                    l = C * C + s * s;
                if (u * u / f < l) return l < h && (0 === C && (l += (C = t(r)) * C), 0 === s && (l += (s = t(r)) * s), l < a && (l = Math.sqrt(a * l)), i.vx += C * A.value * g / l, i.vy += s * A.value * g / l), !0;
                if (!(A.length || l >= h)) {
                    (A.data !== i || A.next) && (0 === C && (l += (C = t(r)) * C), 0 === s && (l += (s = t(r)) * s), l < a && (l = Math.sqrt(a * l)));
                    do {
            ...
            function a() {
                for (var A, n, a, f, C, s, Q, B = i.length, y = 0; y < I; ++y)
                    for (n = o(i, u, l).visitAfter(h), A = 0; A < B; ++A) a = i[A], s = r[a.index], Q = s * s, f = a.x + a.vx, C = a.y + a.vy, n.visit(c);

                function c(A, n, i, r, I) {
                    var o = A.data,
                        h = A.r,
                        u = s + h;
                    if (!o) return n > f + u || r < f - u || i > C + u || I < C - u;
                    if (o.index > a.index) {
                        var l = f - o.x - o.vx,
                            B = C - o.y - o.vy,
                            y = l * l + B * B;
                        y < u * u && (0 === l && (y += (l = t(g)) * l), 0 === B && (y += (B = t(g)) * B), y = (u - (y = Math.sqrt(y))) / y * e, a.vx += (l *= y) * (u = (h *= h) / (Q + h)), a.vy += (B *= y) * u, o.vx -= l * (u = 1 - u), o.vy -= B * u)
                    }
                }
            }

            function h(A) {
                if (A.data) return A.r = r[A.data.index];
                for (var t = A.r = 0; t < 4; ++t) A[t] && A[t].r > A.r && (A.r = A[t].r)
            }

            function f() {
                if (i) {
                    var A, t, g = i.length;
                    for (r = new Array(g), A = 0; A < g; ++A) t = i[A], r[t.index] = +n(t, A, i)
                }
            }
            ...
            for (var A = 0; A < M.length; ++A) {
                var t = M[A];
                null == t.fx ? t.x += t.vx *= .6 : (t.x = t.fx, t.vx = 0), null == t.fy ? t.y += t.vy *= .6 : (t.y = t.fy, t.vy = 0)
            }
        }),
        O = null,
        X = 1e3 / 60,
        L = function(A) {
            for (var t = [], n = new Float32Array(A), i = 0; i < M.length; i++) {
                var r = M[i];
                t.push(r.id), n[2 * i] = r.x, n[2 * i + 1] = r.y
            }
            return t
        },
        m = !1;
    if (self.SharedArrayBuffer) try {
