(() => {
    ...
    function t() {
        ...
        for (var r = window, o = 0, i = ["TouchEvent"]; o < i.length; o++) {
            var s = i[o];
            void 0 === r[s] && (r[s] = function() {})
        }
        try {
            var a = window.matchMedia;
            a && !a("(prefers-color-scheme: dark)").addEventListener && (window.matchMedia = function(t) {
                var e = a(t);
        ...
        window.ResizeObserver || (window.ResizeObserver = function() {
        ...
        }()), Object.isEmpty || e(Object, "isEmpty", (function(e) {
            for (var n in e)
                if (t(e, n)) return !1;
            return !0
        })), Object.each || (Object.each = function(e, n, r) {
            for (var o in e)
                if (t(e, o) && !1 === n.call(r, e[o], o)) return !1;
            return !0
            ...
            return o
        }), e(Array.prototype, "first", (function() {
            if (0 !== this.length) return this[0]
        })), e(Array.prototype, "last", (function() {
            if (0 !== this.length) return this[this.length - 1]
        })), e(Array.prototype, "contains", Array.prototype.includes || function(t) {
            return -1 !== this.indexOf(t)
        }), e(Array.prototype, "remove", (function(t) {
            for (var e = this.length - 1; e >= 0; e--) this[e] === t && this.splice(e, 1)
        })), e(Array.prototype, "shuffle", (function() {
            for (var t, e, n = this.length; 0 !== n;) e = Math.floor(Math.random() * n), t = this[n -= 1], this[n] = this[e], this[e] = t;
            return this
        })), e(Array.prototype, "findLastIndex", (function(t) {
            for (var e = this.length - 1; e <= 0; e--)
                if (t(this[e], e)) return e;
            return -1
        })), e(Array.prototype, "unique", (function() {
            return Array.from(new Set(this).values())
        })), e(Math, "clamp", (function(t, e, n) {
            return Math.min(Math.max(t, e), n)
        })), e(Math, "square", (function(t) {
            return t * t
        })), e(String, "isString", (function(t) {
            return "string" == typeof t || t instanceof String
        })), e(String.prototype, "contains", String.prototype.includes || function(t) {
            return -1 !== this.indexOf(t)
        }), e(String.prototype, "startsWith", (function(t, e) {
            return this.substr(!e || e < 0 ? 0 : +e, t.length) === t
        })), e(String.prototype, "endsWith", (function(t, e) {
            var n = void 0 === e || e > this.length ? this.length : e;
            return this.substring(n - t.length, n) === t
        })), e(String.prototype, "format", (function() {
            for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
            return this.replace(/{(\d+)}/g, (function(e, n) {
                return void 0 !== t[n] ? t[n] : e
            }))
        })), e(Number, "isNumber", (function(t) {
            return "number" == typeof t
        })), e(window, "isBoolean", (function(t) {
        ...
        var c = function(t) {
            ...
            if (1 === e || 9 === e || 11 === e) {
                ...
                for (var n = [], r = t.firstChild; r; r = r.nextSibling) n.push(c(r));
                return n.join("")
            }
        ...
        Element.prototype.getText = function() {
            ...
            e(t, "prepend", (function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                for (var n = document.createDocumentFragment(), r = 0, o = t; r < o.length; r++) {
                    var i = o[r];
                    n.appendChild(String.isString(i) ? document.createTextNode(String(i)) : i)
                }
        ...
        }, Element.prototype.getAttr = Element.prototype.getAttribute, e(Element.prototype, "matchParent", (function(t, e) {
        ...
        }, e(Element.prototype, "isActiveElement", (function() {
            for (var t = this; t;) {
        ...
        }), e(HTMLElement.prototype, "isShown", (function() {
        ...
        })), e(HTMLElement.prototype, "setCssStyles", u), e(SVGElement.prototype, "setCssStyles", u), e(HTMLElement.prototype, "setCssProps", p), e(SVGElement.prototype, "setCssProps", p), e(HTMLElement.prototype, "addEventListeners", (function(t) {
            for (var e in t)
                if (t.hasOwnProperty(e)) {
                    var n = e,
                        r = t[n];
            ...
            var o = e || {},
                ...
                d = o.prepend,
                h = o.href;
            for (var y in i && (Array.isArray(i) ? r.className = i.join(" ") : r.className = i), s && r.setText(s), a && r.setAttrs(a), void 0 !== c && (r.title = c), void 0 !== u && (r instanceof HTMLInputElement || r instanceof HTMLSelectElement || r instanceof HTMLOptionElement) && (r.value = u), l && r instanceof HTMLInputElement && (r.type = l), l && r instanceof HTMLStyleElement && r.setAttribute("type", l), p && r instanceof HTMLInputElement && (r.placeholder = p), h && (r instanceof HTMLAnchorElement || r instanceof HTMLLinkElement || r instanceof HTMLBaseElement) && (r.href = h), n && n(r), f && (d ? f.insertBefore(r, f.firstChild) : f.appendChild(r)), e)
            ...
            var r, o = document.createElementNS("http://www.w3.org/2000/svg", t);
            "string" == typeof e && (e = {
                cls: e
            });
            var i = e || {},
                ...
                c = i.parent,
                u = i.prepend;
            return s && (Array.isArray(s) ? (r = o.classList).add.apply(r, s) : o.classList.add(s)), a && o.setAttrs(a), n && n(o), c && (u ? c.insertBefore(o, c.firstChild) : c.appendChild(o)), o
        ...
        HTMLElement.prototype.on = l, HTMLElement.prototype.off = f, Document.prototype.on = l, Document.prototype.off = f, HTMLElement.prototype.onClickEvent = function(t, e) {
        ...
        HTMLElement.prototype.onNodeInserted = function(t, e) {
            var n = this,
                r = function(r) {
                    n.isShown() && "node-inserted" === r.animationName && r.target === n && (e && o(), t())
                },
                o = function() {
                    n.removeEventListener("animationstart", r);
                    var t = (d.get(n) || 0) - 1;
                    t <= 0 ? (d.delete(n), n.removeClass("node-insert-event")) : d.set(n, t)
                };
            return d.set(this, (d.get(this) || 0) + 1), this.addClass("node-insert-event"), this.addEventListener("animationstart", r), o
            ...
            if (t.req = c, c.open(e, n, !0), c.onload = function() {
                    var t = c.status,
                        e = c.response;
                    t >= 200 && t < 400 ? r && r(e, c) : o && o(e, c)
                }, c.onerror = function(t) {
                    o && o(t, c)
                }, s)
                for (var u in s) s.hasOwnProperty(u) && c.setRequestHeader(u, s[u]);
            c.withCredentials = a || !1, i ? (void 0 === a && (c.withCredentials = !0), String.isString(i) ? c.send(i) : i instanceof ArrayBuffer ? (c.setRequestHeader("Content-Type", "application/octet-stream"), c.send(i)) : (c.setRequestHeader("Content-Type", "application/json; charset=utf-8"), c.send(JSON.stringify(i)))) : c.send()
