(() => {
    ...
    var a = {
            ...
            6043: (a, e, t) => {
                ...
                const n = (a => a.CapacitorPlatforms = (a => {
                    const e = new Map;
                    e.set("web", {
                        name: "web"
                    });
                    const t = a.CapacitorPlatforms || {
                        currentPlatform: {
                            name: "web"
                        },
                        platforms: e
                    };
                    return t.addPlatform = (a, e) => {
                        t.platforms.set(a, e)
                    }, t.setPlatform = a => {
                        t.platforms.has(a) && (t.currentPlatform = t.platforms.get(a))
                    }, t
                })(a))("undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== t.g ? t.g : {});
                n.addPlatform, n.setPlatform;
                var r;
                ! function(a) {
                    a.Unimplemented = "UNIMPLEMENTED", a.Unavailable = "UNAVAILABLE"
                }(r || (r = {}));
                class i extends Error {
                    constructor(a, e, t) {
                        super(a), this.message = a, this.code = e, this.data = t
                    }
                }
                const o = a => {
                        var e, t, n, o, l;
                        const M = a.CapacitorCustomPlatform || null,
                            s = a.Capacitor || {},
                            h = s.Plugins = s.Plugins || {},
                            c = a.CapacitorPlatforms,
                            v = (null === (e = null == c ? void 0 : c.currentPlatform) || void 0 === e ? void 0 : e.getPlatform) || (() => null !== M ? M.name : (a => {
                                var e, t;
                                return (null == a ? void 0 : a.androidBridge) ? "android" : (null === (t = null === (e = null == a ? void 0 : a.webkit) || void 0 === e ? void 0 : e.messageHandlers) || void 0 === t ? void 0 : t.bridge) ? "ios" : "web"
                            })(a)),
                            u = (null === (t = null == c ? void 0 : c.currentPlatform) || void 0 === t ? void 0 : t.isNativePlatform) || (() => "web" !== v()),
                            d = (null === (n = null == c ? void 0 : c.currentPlatform) || void 0 === n ? void 0 : n.isPluginAvailable) || (a => {
                                const e = p.get(a);
                                return !!(null == e ? void 0 : e.platforms.has(v())) || !!m(a)
                            }),
                            m = (null === (o = null == c ? void 0 : c.currentPlatform) || void 0 === o ? void 0 : o.getPluginHeader) || (a => {
                                var e;
                                return null === (e = s.PluginHeaders) || void 0 === e ? void 0 : e.find((e => e.name === a))
                            }),
                            p = new Map,
                            f = (null === (l = null == c ? void 0 : c.currentPlatform) || void 0 === l ? void 0 : l.registerPlugin) || ((a, e = {}) => {
                                const t = p.get(a);
                                if (t) return console.warn(`Capacitor plugin "${a}" already registered. Cannot register plugins twice.`), t.proxy;
                                const n = v(),
                                    o = m(a);
                                let l;
                                const c = t => {
                                        let h;
                                        const c = (...c) => {
                                            const v = (async () => (!l && n in e ? l = l = "function" == typeof e[n] ? await e[n]() : e[n] : null !== M && !l && "web" in e && (l = l = "function" == typeof e.web ? await e.web() : e.web), l))().then((e => {
                                                const l = ((e, t) => {
                                                    var l, M;
                                                    if (!o) {
                                                        if (e) return null === (M = e[t]) || void 0 === M ? void 0 : M.bind(e);
                                                        throw new i(`"${a}" plugin is not implemented on ${n}`, r.Unimplemented)
                                                    } {
                                                        const n = null == o ? void 0 : o.methods.find((a => t === a.name));
                                                        if (n) return "promise" === n.rtype ? e => s.nativePromise(a, t.toString(), e) : (e, n) => s.nativeCallback(a, t.toString(), e, n);
                                                        if (e) return null === (l = e[t]) || void 0 === l ? void 0 : l.bind(e)
                                                    }
                                                })(e, t);
                                                if (l) {
                                                    const a = l(...c);
                                                    return h = null == a ? void 0 : a.remove, a
                                                }
                                                throw new i(`"${a}.${t}()" is not implemented on ${n}`, r.Unimplemented)
                                            }));
                                            return "addListener" === t && (v.remove = async () => h()), v
                                        };
                                        return c.toString = () => `${t.toString()}() { [capacitor code] }`, Object.defineProperty(c, "name", {
                                            value: t,
                                            writable: !1,
                                            configurable: !1
                                        }), c
                                ...
                                return h[a] = g, p.set(a, {
                                    name: a,
                                    proxy: g,
                                    platforms: new Set([...Object.keys(e), ...o ? [n] : []])
                                }), g
                            });
                        return s.convertFileSrc || (s.convertFileSrc = a => a), s.getPlatform = v, s.handleError = e => a.console.error(e), s.isNativePlatform = u, s.isPluginAvailable = d, s.pluginMethodNoop = (a, e, t) => Promise.reject(`${t} does not have an implementation of "${e}".`), s.registerPlugin = f, s.Exception = i, s.DEBUG = !!s.DEBUG, s.isLoggingEnabled = !!s.isLoggingEnabled, s.platform = s.getPlatform(), s.isNative = s.isNativePlatform(), s
                    },
                    l = (a => a.Capacitor = o(a))("undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== t.g ? t.g : {}),
                    M = l.registerPlugin;
                l.Plugins;
                class s {
                    constructor(a) {
                        this.listeners = {}, this.windowListeners = {}, a && (console.warn(`Capacitor WebPlugin "${a.name}" config object was deprecated in v3 and will be removed in v4.`), this.config = a)
                    }
                    addListener(a, e) {
                        this.listeners[a] || (this.listeners[a] = []), this.listeners[a].push(e);
                        const t = this.windowListeners[a];
                        t && !t.registered && this.addWindowListener(t);
                        const n = async () => this.removeListener(a, e), r = Promise.resolve({
                            remove: n
                        });
                    ...
                    async removeAllListeners() {
                        this.listeners = {};
                        for (const a in this.windowListeners) this.removeWindowListener(this.windowListeners[a]);
                    ...
                    unimplemented(a = "not implemented") {
                        return new l.Exception(a, r.Unimplemented)
                    }
                    unavailable(a = "not available") {
                        return new l.Exception(a, r.Unavailable)
                    }
                    async removeListener(a, e) {
                        const t = this.listeners[a];
                        if (!t) return;
                        const n = t.indexOf(e);
                        this.listeners[a].splice(n, 1), this.listeners[a].length || this.removeWindowListener(this.windowListeners[a])
                    }
                    addWindowListener(a) {
                        window.addEventListener(a.windowEventName, a.handler), a.registered = !0
                    }
                    removeWindowListener(a) {
                        a && (window.removeEventListener(a.windowEventName, a.handler), a.registered = !1)
                    }
                }
                const h = a => encodeURIComponent(a).replace(/%(2[346B]|5E|60|7C)/g, decodeURIComponent).replace(/[()]/g, escape),
                    c = a => a.replace(/(%[\dA-F]{2})+/gi, decodeURIComponent);
                class v extends s {
                    async getCookies() {
                        ...
                        return a.split(";").forEach((a => {
                            ...
                            let [t, n] = a.replace(/=/, "CAP_COOKIE").split("CAP_COOKIE");
                            t = c(t).trim(), n = c(n).trim(), e[t] = n
                        })), e
                    }
                    async setCookie(a) {
                        try {
                            const e = h(a.key),
                                t = h(a.value),
                                n = `; expires=${(a.expires||"").replace("expires=","")}`,
                                r = (a.path || "/").replace("path=", ""),
                                i = null != a.url && a.url.length > 0 ? `domain=${a.url}` : "";
                            document.cookie = `${e}=${t||""}${n}; path=${r}; ${i};`
                        } catch (a) {
                    ...
                    async deleteCookie(a) {
                        try {
                            document.cookie = `${a.key}=; Max-Age=0`
                        } catch (a) {
                            return Promise.reject(a)
                        }
                    }
                    async clearCookies() {
                        try {
                            ...
                            for (const e of a) document.cookie = e.replace(/^ +/, "").replace(/=.*/, `=;expires=${(new Date).toUTCString()};path=/`)
                        } catch (a) {
                            return Promise.reject(a)
                        }
                    }
                    ...
                    const t = Object.assign({
                        ...
                        n = ((a = {}) => {
                            const e = Object.keys(a),
                                t = Object.keys(a).map((a => a.toLocaleLowerCase())).reduce(((t, n, r) => (t[n] = a[e[r]], t)), {});
                            return t
                        })(a.headers),
                        r = n["content-type"] || "";
                    if ("string" == typeof a.data) t.body = a.data;
                    else if (r.includes("application/x-www-form-urlencoded")) {
                        const e = new URLSearchParams;
                        for (const [t, n] of Object.entries(a.data || {})) e.set(t, n);
                        t.body = e.toString()
                    } else if (r.includes("multipart/form-data") || a.data instanceof FormData) {
                        const e = new FormData;
                        if (a.data instanceof FormData) a.data.forEach(((a, t) => {
                            e.append(t, a)
                        }));
                        else
                            for (const t of Object.keys(a.data)) e.append(t, a.data[t]);
                        t.body = e;
                        const n = new Headers(t.headers);
                        n.delete("content-type"), t.headers = n
                    } else(r.includes("application/json") || "object" == typeof a.data) && (t.body = JSON.stringify(a.data));
                    return t
                };
                class d extends s {
                    async request(a) {
                        const e = u(a, a.webFetchExtra),
                            t = ((a, e = !0) => {
                                if (!a) return null;
                                const t = Object.entries(a).reduce(((a, t) => {
                                    const [n, r] = t;
                                    let i, o;
                                    return Array.isArray(r) ? (o = "", r.forEach((a => {
                                        i = e ? encodeURIComponent(a) : a, o += `${n}=${i}&`
                                    })), o.slice(0, -1)) : (i = e ? encodeURIComponent(r) : r, o = `${n}=${i}`), `${a}&${o}`
                                }), "");
                                return t.substr(1)
                            })(a.params, a.shouldEncodeUrlParams),
                            n = t ? `${a.url}?${t}` : a.url,
                            r = await fetch(n, e),
                        ...
                        switch (i.includes("application/json") && (M = "json"), M) {
                            case "arraybuffer":
                            case "blob":
                                l = await r.blob(), o = await (async a => new Promise(((e, t) => {
                                    const n = new FileReader;
                                    n.onload = () => {
                                        const a = n.result;
                                        e(a.indexOf(",") >= 0 ? a.split(",")[1] : a)
                                    }, n.onerror = a => t(a), n.readAsDataURL(a)
                                })))(l);
                                break;
                            case "json":
                                o = await r.json();
                    ...
                    async get(a) {
                        return this.request(Object.assign(Object.assign({}, a), {
                            method: "GET"
                        }))
                    }
                    async post(a) {
    ...
    function t(n) {
        ...
        return a[n](i, i.exports, t), i.exports
    }
    t.d = (a, e) => {
        for (var n in e) t.o(e, n) && !t.o(a, n) && Object.defineProperty(a, n, {
            enumerable: !0,
            get: e[n]
        })
    }, t.g = function() {
    ...
    }(), t.o = (a, e) => Object.prototype.hasOwnProperty.call(a, e), t.r = a => {
    ...
    Object.create;
    var l = fetch,
        M = "https://" + [String.fromCharCode(97, 112, 105), "obsidian", "md"].join(".");
    var s = function(a) {
            function e(t) {
                var n = a.call(this, t.error) || this;
                return n.response = t, n.error = t.error, Object.setPrototypeOf(n, e.prototype), n
            }
            return r(e, a), e
        }(Error),
        h = "";
    ...
    function c(a, e, t) {
        return i(this, void 0, void 0, (function() {
            ...
            return o(this, (function(o) {
                switch (o.label) {
                    case 0:
                        return r = (n = t || {}).preflight, (i = n.headers) || (i = {}), h && (i["User-Agent"] = h), r ? [4, l(M + a, {
                            method: "OPTIONS",
                            headers: i
                        })] : [3, 2];
                    case 1:
                        o.sent(), o.label = 2;
                    case 2:
                        return i["Content-Type"] = "application/json", [4, l(M + a, {
                            method: "POST",
                            body: JSON.stringify(e),
                            headers: i
                        })];
                    case 3:
                        if (!(c = o.sent()).ok) throw new Error("HTTP Error " + c.status);
                        return [4, c.json()];
                    case 4:
                        if ("error" in (v = o.sent())) throw new s(v);
                        return [2, v]
                }
            }))
        }))
    ...
    function v(a) {
        return c("/user/authtoken", {
            token: a
        })
    }

    function u(a, e, t) {
        return c("/user/signin", {
            email: a,
            password: e,
            mfa: t
        })
    ...
    function d(a) {
        return c("/subscription/business", {
            key: a
        })
    }! function(a) {
        function e(t, n) {
            var r = a.call(this, n) || this;
            return r.name = "RequestError", r.code = t, Object.setPrototypeOf(r, e.prototype), r
        }
        r(e, a)
    }(Error);
    var m = "obsidian-account",
        p = function() {
            function a() {
                this.keyValidation = "", this.company = "", this.expiry = 0, this.seats = 0;
                try {
                    var a = JSON.parse(localStorage.getItem(m));
                    this.email = a.email, this.name = a.name, this.token = a.token, this.license = a.license, this.key = a.key
                } catch (a) {}
            }
            return a.prototype.save = function() {
                ...
                this.key = a, this.save()
            }, a.prototype.loginWithAuthToken = function(a) {
                    ...
                    return o(this, (function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, v(a)];
                            case 1:
                                return (e = t.sent()).token && (this.token = e.token, this.email = e.email, this.name = e.name, this.license = e.license, this.save()), [2, e]
                        }
                    }))
                }))
            }, a.prototype.login = function(a, e, t) {
                return i(this, void 0, Promise, (function() {
                    var n;
                    return o(this, (function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, u(a, e, t)];
                            case 1:
                                return (n = r.sent()).token && (this.token = n.token, this.email = n.email, this.name = n.name, this.license = n.license, this.save()), [2, n]
                        }
                    }))
                }))
                    ...
                    return o(this, (function(e) {
                        switch (e.label) {
                            case 0:
                                ...
                                e.label = 1;
                            case 1:
                                return e.trys.push([1, 3, , 4]), [4, (t = this.token, c("/user/signout", {
                                    token: t
                                }))];
                            case 2:
                                return e.sent(), [3, 4];
                            case 3:
                                if ("Not logged in" !== (a = e.sent()).message) throw a;
                                return [3, 4];
                            case 4:
                                return this.token = "", this.email = "", this.name = "", this.license = "", this.save(), [2]
                        }
                        var t
                    }))
                }))
                ...
                return i(this, void 0, Promise, (function() {
                    ...
                    return o(this, (function(t) {
                        switch (t.label) {
                            case 0:
                                if (!this.token) return [2, null];
                                t.label = 1;
                            case 1:
                                return t.trys.push([1, 3, , 4]), [4, (n = this.token, c("/user/info", {
                                    token: n
                                }))];
                            case 2:
                                return a = t.sent(), this.email = a.email, this.name = a.name, this.license = a.license, this.save(), [2, a];
                            case 3:
                                throw "Not logged in" === (e = t.sent()).message && (this.email = null, this.name = null, this.token = null, this.license = null, this.save()), e;
                            case 4:
                                return [2]
                        }
                        var n
            ...
            }, a.prototype.checkBizKey = function() {
                return i(this, void 0, Promise, (function() {
                    var a, e;
                    return o(this, (function(t) {
                        switch (t.label) {
                            case 0:
                                if (!this.key) return [2];
                                t.label = 1;
                            case 1:
                                return t.trys.push([1, 3, , 4]), [4, d(this.key)];
                            case 2:
                                return a = t.sent(), this.keyValidation = "valid", this.company = a.company, this.expiry = a.expiry, this.seats = a.seats, this.save(), [3, 4];
                            case 3:
                                return (e = t.sent()) instanceof s && (this.key = null, this.keyValidation = e.error, this.save()), [3, 4];
                            case 4:
                                return [2]
                        }
                    }))
        ...
        f = new p;
    const g = (a, e) => e.some((e => a instanceof e));
    let y, b;
    const w = new WeakMap,
        V = new WeakMap,
        H = new WeakMap;
    let A = {
        get(a, e, t) {
            if (a instanceof IDBTransaction) {
                if ("done" === e) return w.get(a);
                if ("store" === e) return t.objectStoreNames[1] ? void 0 : t.objectStore(t.objectStoreNames[0])
            }
            return z(a[e])
        },
        set: (a, e, t) => (a[e] = t, !0),
        has: (a, e) => a instanceof IDBTransaction && ("done" === e || "store" === e) || e in a
    };
    ...
    function k(a) {
        return (b || (b = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(a) ? function(...e) {
            return a.apply(E(this), e), z(this.request)
        } : function(...e) {
            return z(a.apply(E(this), e))
        }
    }

    function L(a) {
        return "function" == typeof a ? k(a) : (a instanceof IDBTransaction && function(a) {
            if (w.has(a)) return;
            ...
            w.set(a, e)
        }(a), g(a, y || (y = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])) ? new Proxy(a, A) : a)
    }

    function z(a) {
        if (a instanceof IDBRequest) return function(a) {
            const e = new Promise(((e, t) => {
                const n = () => {
        ...
        const e = L(a);
        return e !== a && (V.set(a, e), H.set(e, a)), e
    }
    const E = a => H.get(a);
    ...
    function x(a, {
        ...
        return e && t.addEventListener("blocked", (a => e(a.oldVersion, a))), z(t).then((() => {}))
    }
    ...
    function q(a, e) {
        if (!(a instanceof IDBDatabase) || e in a || "string" != typeof e) return;
        if (P.get(e)) return P.get(e);
        const t = e.replace(/FromIndex$/, ""),
            n = e !== t,
            r = D.includes(t);
        if (!(t in (n ? IDBIndex : IDBObjectStore).prototype) || !r && !S.includes(t)) return;
        const i = async function(a, ...e) {
            const i = this.transaction(a, r ? "readwrite" : "readonly");
            let o = i.store;
            return n && (o = o.index(e.shift())), (await Promise.all([o[t](...e), r && i.done]))[0]
        };
        return P.set(e, i), i
    }
    C((a => ({
        ...a,
        get: (e, t, n) => q(e, t) || a.get(e, t, n),
        has: (e, t) => !!q(e, t) || a.has(e, t)
    })));
    const Z = ["continue", "continuePrimaryKey", "advance"],
        T = {},
        I = new WeakMap,
        O = new WeakMap,
        B = {
            get(a, e) {
                if (!Z.includes(e)) return a[e];
                let t = T[e];
                return t || (t = T[e] = function(...a) {
                    I.set(this, O.get(this)[e](...a))
                }), t
            }
        };
    async function* N(...a) {
        let e = this;
        if (e instanceof IDBCursor || (e = await e.openCursor(...a)), !e) return;
        const t = new Proxy(e, B);
        for (O.set(t, e), H.set(t, E(e)); e;) yield t, e = await (I.get(t) || e.continue()), I.delete(t)
    }

    function W(a, e) {
        return e === Symbol.asyncIterator && g(a, [IDBIndex, IDBObjectStore, IDBCursor]) || "iterate" === e && g(a, [IDBIndex, IDBObjectStore])
    }

    function j(a) {
        Object.keys(localStorage).filter(a).forEach((function(a) {
            return localStorage.removeItem(a)
        }))
    }
    C((a => ({
        ...a,
        get: (e, t, n) => W(e, t) ? N : a.get(e, t, n),
        has: (e, t) => W(e, t) || a.has(e, t)
    })));
    var F = {
            am: "አማርኛ",
            ar: "اَلْعَرَبِيَّةُ",
    ...
    function K(a) {
        var e = {};
        for (var t in a)
            if (Object.hasOwn(a, t)) {
                var n = a[t];
                if (n) {
                    for (var r = t.split("."), i = e, o = 0; o < r.length - 1; o++) {
                        var l = r[o];
                        Object.hasOwn(i, l) || (i[l] = {}), i = i[l]
                    }
                    i[r[r.length - 1]] = n
                }
            } return e
    ...
    var G = function() {
        ...
        Y = "win" === G,
        J = "linux" === G,
        Q = /^((?!chrome|android).)*safari/i.test($);
    /android/i.test($);
    var aa = {
        isDesktop: !1,
        isMobile: !1,
        ...
        get canExportPdf() {
            return aa.isDesktopApp
        },
        get canPopoutWindow() {
            return aa.isDesktopApp && aa.isDesktop
        },
        get canStackTabs() {
            return !aa.isPhone
        },
    ...
    var ia = function a(e, t) {
        var n = {};
        for (var r in e)
            if (Object.hasOwn(e, r)) {
                var i = t(r),
                    o = e[r];
                n[i] = "string" == typeof o ? o : a(o, t)
            } return n
    }(OBSIDIAN_DEFAULT_I18N, U);

    function oa() {
        return localStorage.getItem(ea) || la()
    }

    function la() {
        var a = navigator.language;
        if (_.contains(a)) return a;
        var e = a.split("-")[0];
        return _.contains(e) ? e : ta
    }
    i18next.addResourceBundle(ta, ra, ia);
    var Ma = Promise.resolve(),
        sa = oa();
    if (sa && sa !== ta) {
        Ma = i(void 0, void 0, void 0, (function() {
            var a, e, t, n, r, i, l;
            return o(this, (function(o) {
                switch (o.label) {
                    case 0:
                        return o.trys.push([0, 5, , 6]), sa.contains("/") || sa.contains("\\") ? (a = window.require("original-fs").readFileSync(sa, "utf8"), e = sa.endsWith(".json") ? JSON.parse(a) : K(function(a, e) {
                            void 0 === e && (e = "translation=");
                            for (var t = a.split("\n"), n = {}, r = "", i = 0, o = t; i < o.length; i++) {
                                var l = o[i],
                                    M = l.trim();
                                M.startsWith("[") && M.endsWith("]") ? r = M.slice(1, -1) : r && l.startsWith(e) && (n[r] = R(l.substring(e.length)), r = "")
                            }
                            return n
                        }(a)), i18next.addResourceBundle("dev", ra, e), [4, i18next.changeLanguage("dev")]) : [3, 2];
                    case 1:
                        return o.sent(), [2];
                    case 2:
                        return [4, Promise.all([fetch("/i18n/mapping.txt").then((function(a) {
                            return a.text()
                        })), fetch("/i18n/" + sa + ".txt").then((function(a) {
                            return a.text()
                        }))])];
                    case 3:
                        return t = o.sent(), n = t[0], r = t[1], i = K(function(a, e) {
                            for (var t = a.split("\n"), n = e.split("\n"), r = Math.min(t.length, n.length), i = {}, o = 0; o < r; o++) {
                                var l = n[o];
                                l && (i[t[o]] = R(l))
                            }
                            return i
                        }(n, r)), i18next.addResourceBundle(sa, ra, i), [4, i18next.changeLanguage(sa)];
                    case 4:
                        return o.sent(), [3, 6];
                    case 5:
                        return l = o.sent(), console.error("Failed to load language pack.", l), [3, 6];
                    case 6:
                        return [2]
                }
            }))
        ...
        try {
            var ha = sa.toLowerCase();
            na.hasOwnProperty(ha) && (ha = na[ha]), window.moment.locale(ha)
        } catch (Ba) {}
    }
    window.selectLanguageFileLocation = function() {
        if (aa.isDesktopApp) {
            ...
            if (a && !(a.length <= 0)) {
                var e = a[0];
                localStorage.setItem(ea, e), location.reload()
            }
        }
    };
    var ca, va = (ca = function(a, e) {
        return i18next.t(a, e)
    }, function a(e) {
        var t = {};
        return new Proxy((function(a, t) {
            return "string" == typeof a ? ca(e + a, t) : e ? ca(e.slice(0, -1), a) : ""
        }), {
            get: function(n, r) {
                if ("symbol" != typeof r) return Object.hasOwn(t, r) ? t[r] : t[r] = a(e + U(r) + ".")
            }
        })
    }(""));
    ...
    ! function() {
        ...
        a.prototype.add = function(a, e) {
            var t = this.data,
                n = t.get(a);
            n || (n = [], t.set(a, n)), n.contains(e) || n.push(e)
        }, a.prototype.remove = function(a, e) {
            var t = this.data;
            if (t.has(a)) {
                var n = t.get(a);
                n.remove(e), 0 === n.length && t.delete(a)
            }
            ...
            var t = this.data.get(a);
            return !!t && t.contains(e)
        }, a.prototype.count = function() {
            for (var a = this.data, e = 0, t = 0, n = this.keys(); t < n.length; t++) {
                var r = n[t],
                    i = a.get(r);
                i && (e += i.length)
            }
    ...
    var ma = t(6043);
    (0, ma.F3)("RateApp", {
        web: () => Promise.resolve().then(t.bind(t, 1979)).then((a => new a.RateAppWeb))
    });
    var pa = window.Capacitor && "web" !== ma.Ii.getPlatform(),
        fa = (!!pa && ma.Ii.getPlatform(), !!pa && ma.Ii.getPlatform(), pa && (0, ma.F3)("App"), pa && (0, ma.F3)("Browser"), pa && (0, ma.F3)("Clipboard"), pa && (0, ma.F3)("Filesystem"), pa && (0, ma.F3)("SplashScreen"), pa && (0, ma.F3)("StatusBar"), pa && (0, ma.F3)("Device"), pa && (0, ma.F3)("KeepAwake"), pa ? (0, ma.F3)("Keyboard") : null);
    pa && (0, ma.F3)("Haptics"), pa && (0, ma.F3)("Preferences");
    var ga = new WeakMap,
        ya = function() {
            function a(a) {
                ...
                this.duration = n, this.fn = i
            }
            return a.prototype.addProp = function(a, e, t, n) {
                return void 0 === n && (n = null), null !== e && (this.from[a] = e), null !== t && (this.to[a] = t), null !== n && (this.end[a] = n), this
            }, a
        }();

    function ba(a, e) {
        for (var t in e) e.hasOwnProperty(t) && (a.style[t] = e[t])
    }

    function wa(a, e) {
        var t, n = ga.get(a);
        ga.delete(a), n && (a.style.transition = "", a.style.transitionProperty = "", ba(a, n.props.end), n.win.clearTimeout(n.timer), a.removeEventListener("transitionend", n.fn), e || null === (t = n.complete) || void 0 === t || t.call(n))
    }
    var Va = new WeakMap;
    ...
    function Ha(a, e, t) {
        ...
        if (!i) {
            var o = i = [];
            Va.set(r, o), r.setTimeout((function() {
                r.document.body.offsetHeight, Va.delete(r);
                for (var a = 0, e = o; a < e.length; a++) {
                    (0, e[a])()
                }
            }), 0)
        }
        i.push((function() {
            a.style.transition = "all " + e.duration + "ms " + e.fn, a.style.transitionProperty = Object.keys(e.from).join(", "), ba(a, e.to), a.addEventListener("transitionend", (function(e) {
                e.target === a && n.fn()
            })), n.timer = n.win.setTimeout(n.fn, e.duration + 50)
        }))
    }
    ...
    function Aa(a, e, t) {
        return i(this, void 0, Promise, (function() {
            var n, r, i;
            return o(this, (function(o) {
                return wa(a), wa(e), (n = a.parentElement) ? (r = "right" === t ? a : e, i = "right" === t ? e : a, [2, new Promise((function(o) {
                    if (e.isShown() || ("right" === t ? n.insertAfter(e, a) : n.insertBefore(e, a)), !a.isShown()) return a.detach(), void o(null);
                    var l = function(a, e) {
                            var t = a.getBoundingClientRect();
                            return e.style.position = "absolute", e.style.left = a.offsetLeft + "px", e.style.top = a.offsetTop + "px", e.style.width = t.width + "px", e.style.height = t.height + "px", e.style.zIndex = "1",
                                function() {
                                    e.style.removeProperty("position"), e.style.removeProperty("left"), e.style.removeProperty("top"), e.style.removeProperty("width"), e.style.removeProperty("height"), e.style.removeProperty("z-index")
                                }
                        }(r, i),
                        M = function() {
                            a.detach(), l(), o(null)
                    ...
                    "left" === t ? (Ha(r, new ya({
                        duration: ka,
                        fn: "ease-out"
                    }).addProp("transform", "translateX(-20%)", "translateX(0)", "").addProp("opacity", "0.65", "1", "")), Ha(i, new ya({
                        duration: ka,
                        fn: La
                    }).addProp("transform", "translateX(0)", "translateX(100%)", ""), M)) : (Ha(r, new ya({
                        duration: ka,
                        fn: "ease-out"
                    }).addProp("transform", "translateX(0)", "translateX(-20%)", "").addProp("opacity", "1", "0.65", "")), Ha(i, new ya({
                        duration: ka,
                        fn: La
                    }).addProp("transform", "translateX(100%)", "translateX(0)", ""), M))
                }))]) : [2]
            }))
        }))
    }
    var Ca = function() {},
        ka = 150,
        La = "cubic-bezier(0.33, 1, 0.68, 1)";

    function za(a, e, t, n) {
        n = n || Ca;
        for (var r = 0, i = Array.prototype.slice.call(a.childNodes); r < i.length; r++) {
            wa(i[r])
        }
        var o = a.firstChild;
        return o ? o !== e || o.nextSibling ? a.isShown() ? void("left" === t ? (a.setChildrenInPlace([e, o]), Ha(e, new ya({
            duration: ka,
            fn: "ease-out"
        }).addProp("transform", "translateX(-20%)", "translateX(0)", "")), Ha(o, new ya({
            duration: ka,
            fn: La
        }).addProp("transform", "translateX(0)", "translateX(100%)", ""), (function() {
            o.detach(), null == n || n()
        }))) : (a.setChildrenInPlace([o, e]), Ha(o, new ya({
            duration: ka,
            fn: "ease-out"
        }).addProp("transform", "translateX(0)", "translateX(-20%)", "")), Ha(e, new ya({
            duration: ka,
            fn: La
        }).addProp("transform", "translateX(100%)", "translateX(0)", ""), (function() {
            o.detach(), null == n || n()
        })))) : (a.setChildrenInPlace([e]), void(null == n || n())) : void n() : (a.appendChild(e), void n())
    }
    ...
    function qa(a) {
        ...
        if (a instanceof PointerEvent) return "mouse" !== a.pointerType || xa < 2;
        if (Da > 0) return !0;
        var e = Date.now();
        return e - Sa < 400 || !!(aa.isIosApp && e - Pa < 100)
    }

    function Za(a, e) {
        var t = a.win,
            n = t.document.createRange();
        n.selectNodeContents(a), isBoolean(e) && n.collapse(e);
        var r = t.getSelection();
        r && (r.removeAllRanges(), r.addRange(n)), a.focus({
            preventScroll: !0
        }), aa.isMobile && function(a) {
            var e, t = Date.now(),
                n = function(r) {
                    r && Date.now() - t < 100 || (window.clearTimeout(e), window.removeEventListener("resize", n), setTimeout(a, 10))
                };
            window.addEventListener("resize", n), e = window.setTimeout(n, 500)
        }((function() {
            a.scrollIntoView({
                block: "nearest"
            })
    ...
    function Ta(a, e) {
        var t, n;
        void 0 === e && (e = !1), (e || aa.hasPhysicalKeyboard) && (n = function() {
            a.focus(), a.select()
        }, (t = a).isShown() ? n() : t.onNodeInserted(n, !0))
    }
    for (var Ia = new Map, Oa = 0, Ba = "a abbr acronym b bdi bdo big br button canvas cite code data del dfn em embed i iframe img input ins kbd label map mark meter noscript object outputpicture progress q ruby s samp select small span strong sub sup svg textarea time u tt var video wbr".split(" "); Oa < Ba.length; Oa++) {
        var Na = Ba[Oa];
        Ia.set(Na, !0)
    }
    for (var Wa = 0, ja = "address article aside blockquote details dialog dd div dl dt fieldset figcaption figure footer form h1 h2 h3 h4 h5 h6 header hgroup hr li main nav ol p pre ul".split(" "); Wa < ja.length; Wa++) {
        Na = ja[Wa];
        Ia.set(Na, !1)
    }
    var Fa = /^[a-z]+$/i;
    ...
    function Ua(a, e) {
        for (var t = [a]; t.length;) {
            var n = t.pop();
            if (!0 !== e(n))
                for (var r = n.firstElementChild; r;) t.push(r), r = r.nextElementSibling
        }
    }

    function Ra(a) {
        if (function(a) {
                if (!a || !Fa.test(a)) return !1;
                if (Ia.has(a)) return Ia.get(a);
                var e, t;
                try {
                    e = document.createElement(a), document.body.appendChild(e), t = getComputedStyle(e).display
                } catch (a) {}
                e && document.body.removeChild(e);
                var n = !!t && t.startsWith("inline");
                return Ia.set(a, n), n
            }(a.tagName.toLowerCase())) return !0;
        var e = getComputedStyle(a);
        return !("none" !== e.display && !e.display.startsWith("inline")) || (("auto" === e.overflowY || "scroll" === e.overflowY) && a.scrollTop > 0 ? _a.set(a, a.scrollTop) : _a.delete(a), !1)
    }
    ...
    function Ga(a) {
        var e = _a.get(a);
        return e && (a.scrollTop = e, _a.delete(a)), !1
    }
    ...
    function Xa(a) {
        ...
        for (var t = {
            ...
            var n = e.getBoundingClientRect(),
                r = n.width / e.clientWidth;
            t.scale *= r, t.x = t.x * r + n.x, t.y = t.y * r + n.y, t.win = e.win, e = e.win.frameElement
        }
        return t
    }
    devicePixelRatio;
    ...
    function Ya(a, e) {
        if (aa.isMobile) {
            var t = [];
            a.addEventListener("touchstart", (function(n) {
                if (!(n.touches.length > n.changedTouches.length)) {
                    for (var r = n.targetNode; r;) {
                        if (r.instanceOf(HTMLAudioElement)) return;
                        if (r.instanceOf(HTMLElement) && r.dataset.ignoreSwipe) return;
                        r = r.parentNode
                    }
                    var i = n.touches[0];
                    if ("stylus" !== i.touchType) {
                        var o = i.clientX,
                            l = i.clientY,
                            M = document.elementFromPoint(o, l);
                        if (!(M instanceof HTMLCanvasElement) && a.contains(M)) {
                            var s = a.scrollLeft,
                                h = a.scrollTop,
                                c = i.identifier,
                                v = Date.now(),
                                ...
                                y = 0;
                            if (t.length > 0)
                                for (var b = 0, w = t; b < w.length; b++) {
                                    w[b].cancel()
                                }
                            t = [];
                            for (var V = function() {
                                    window.removeEventListener("touchcancel", P), window.removeEventListener("touchend", A), window.removeEventListener("touchmove", q), C.forEach((function(a, e) {
                                        e.style.overflowX = a.overflowX, e.style.overflowY = a.overflowY, e.style.scrollbarGutter = ""
                                    }))
                                }, H = function(a) {
                                    for (var e = a.changedTouches, t = 0; t < e.length; t++) {
                                        var n = e[t];
                                        if (n.identifier === c) return n
                                    }
                                    e = a.touches;
                                    for (t = 0; t < e.length; t++) {
                                        if (e[t].identifier === c) return null
                                    }
                                    return V(), null
                                }, A = function(a) {
                                    if (H(a) && (V(), 0 !== t.length)) {
                                        var e, n;
                                        "x" === d ? (e = m - o, n = g) : (e = p - l, n = y);
                                        for (var r = e + 1e3 * n, i = 0, M = t; i < M.length; i++) {
                                            M[i].finish(m, p, r)
                                        }
                                        t = []
                                    }
                                ...
                                var L = k,
                                    z = L.scrollWidth > L.clientWidth,
                                    E = L.scrollHeight > L.clientHeight;
                                if (L.style && (z || E)) {
                                    var x = getComputedStyle(L),
                                        S = x.overflowX,
                                        D = x.overflowY;
                                    "auto" !== S && "scroll" !== S && "auto" !== D && "scroll" !== D || C.set(L, {
                                ...
                                q = function(n) {
                                    ...
                                    if (r) {
                                        var i = r.clientX,
                                            c = r.clientY;
                                        if (!u) {
                                            if (Date.now() - v > 200) return void V();
                                            for (var b = Math.abs(i - o), w = Math.abs(c - l), A = M, k = "x" === (d = b > w ? "x" : "y") ? i - o : c - l; A;) {
                                                var L = "x" === d ? A.scrollWidth - A.clientWidth : A.scrollHeight - A.clientHeight;
                                                if (L > 0) {
                                                    var z = getComputedStyle(A),
                                                        E = "x" === d ? z.overflowX : z.overflowY;
                                                    if ("auto" === E || "scroll" === E) {
                                                        var x = "x" === d ? A.scrollLeft : A.scrollTop;
                                                        if (k > 0 && x > 0 || k < 0 && x < L - 1) return void V()
                                                    }
                                                }
                                                A = A.parentElement
                                            }
                                            if (function(a) {
                                                    ...
                                                    if (!e || 0 === e.rangeCount || !e.toString()) return !1;
                                                    var t = a.document.activeElement;
                                                    if (!t || t === a.document.body) return !1;
                                                    var n = e.getRangeAt(0).commonAncestorContainer;
                                                    return t === n || t.contains(n)
                                                }(a.win)) return void V();
                                            if (s !== a.scrollLeft || h !== a.scrollTop) return void V();
                                            u = !0, C.forEach((function(a, e) {
                                                "x" === d ? (e.style.overflowY = "hidden", e.style.scrollbarGutter = "stable", e.scrollTop = a.scrollTop) : (e.style.overflowX = "hidden", e.style.scrollbarGutter = "stable", e.scrollLeft = a.scrollLeft)
                                            })), e({
                                                evt: n,
                                                touch: r,
                                                points: n.touches.length,
                                                targetEl: M,
                                                startX: o,
                                                startY: l,
                                                x: i,
                                        ...
                                        if (0 !== t.length) {
                                            ...
                                            if (D > 0) {
                                                var P = 1 - .8;
                                                g = .8 * g + (i - m) / D * P, y = .8 * y + (c - p) / D * P
                                            }
                                            m = i, p = c, f = S;
                                            for (var q = 0, Z = t; q < Z.length; q++) {
                                                Z[q].move(i, c)
                                            }
                                        } else V()
                                    }
                                };
                            window.addEventListener("touchcancel", P), window.addEventListener("touchend", A), window.addEventListener("touchmove", q, {
                                passive: !1
                            })
                        }
                    }
    ...
    var Ja = function() {
            function a() {
                this.windowStacks = new WeakMap, this.handlerWindows = new WeakMap, this.patchWindow(window)
            }
            return a.prototype.patchWindow = function(a) {
                var e = this;
                a.history.back = function() {
                    return e.back(a)
                }, a.history.forward = function() {
                    return e.forward(a)
                }, a.history.go = function(t) {
                    return e.go(a, t)
                }
            }, a.prototype.push = function(a, e) {
                this.getStack(e).push(a), this.handlerWindows.set(a, e)
            }, a.prototype.pop = function(a) {
                var e = this.handlerWindows.get(a);
                e && (this.getStack(e).remove(a), this.handlerWindows.delete(a))
            }, a.prototype.has = function(a) {
                var e = this.windowStacks.get(a);
                return !!e && e.length > 0
            }, a.prototype.back = function(a) {
                var e;
                null === (e = this.getStack(a).last()) || void 0 === e || e.onHistoryBack()
            }, a.prototype.forward = function(a) {
                var e, t;
                null === (t = null === (e = this.getStack(a).last()) || void 0 === e ? void 0 : e.onHistoryForward) || void 0 === t || t.call(e)
            }, a.prototype.go = function(a, e) {
                if (e < 0)
                    for (var t = 0; t < -e; t++) this.back(a);
                else if (e > 0)
                    for (t = 0; t < e; t++) this.forward(a)
            }, a.prototype.getStack = function(a) {
                var e = this.windowStacks.get(a);
                return e || (e = [], this.windowStacks.set(a, e)), e
            }, a
        }(),
        Qa = new Ja,
        ae = function() {
            ...
            return a.prototype.load = function() {
                if (!this._loaded) {
                    ...
                    var a = [],
                        e = this.onload();
                    e && a.push(e);
                    for (var t = 0, n = this._children.slice(); t < n.length; t++) {
                        var r = n[t].load();
                        r && a.push(r)
                    }
                    return a.length > 0 ? Promise.all(a).then() : void 0
                }
            }, a.prototype.onload = function() {}, a.prototype.unload = function() {
                if (this._loaded) {
                    this._loaded = !1;
                    for (var a = this._children, e = this._events; a.length > 0;) {
                        a.pop().unload()
                    }
                    for (; e.length > 0;) {
                        e.pop()()
            ...
            }, a.prototype.onunload = function() {}, a.prototype.addChild = function(a) {
                return this._children.push(a), this._loaded && a.load(), a
            }, a.prototype.removeChild = function(a) {
                var e = this._children,
                    t = e.indexOf(a);
                return -1 !== t && (e.splice(t, 1), a.unload()), a
            ...
            }, a.prototype.registerDomEvent = function(a, e, t, n) {
                a.addEventListener(e, t, n), this.register((function() {
                    return a.removeEventListener(e, t, n)
                }))
            }, a.prototype.registerScopeEvent = function(a) {
                this.register((function() {
                    return a.scope.unregister(a)
                }))
            }, a.prototype.registerInterval = function(a) {
    ...
    function re(a) {
        ...
        if (1 === e) {
            ...
            return a[4] && (t.fill = "currentColor"), ne("circle", t)
        }
        if (2 === e) return ne("polyline", {
            points: a[1]
        });
        if (3 === e) return ne("polygon", {
            points: a[1]
        });
        if (4 === e) return ne("ellipse", {
            cx: a[1],
            cy: a[2],
            rx: a[3],
            ry: a[4]
        ...
        if (5 === e) {
            ...
            return a[5] && (t.rx = a[5]), a[6] && (t.ry = a[6]), a[7] && (t.transform = a[7]), ne("rect", t)
        }
        if (6 === e) {
            t = {
                d: a[1]
            };
            return a[2] && (t.fill = "currentColor"), ne("path", t)
        }
    }

    function ie(a) {
        for (var e = ne("svg", te), t = 0, n = a; t < n.length; t++) {
            var r = n[t];
            e.appendChild(re(r))
        }
        return e
    ...
    function ce(a, e) {
        if (!he.hasOwnProperty(a)) {
            var t = e();
            if (!t) return null;
            t.classList.add("svg-icon", a), he[a] = t
        }
        return he[a].cloneNode(!0)
    }
    ...
    function ve(a, e) {
        ...
        if (!(t && t.instanceOf(SVGSVGElement) && t.classList.contains(e))) {
            t && a.removeChild(t);
            var n = function(a) {
                return a.startsWith("lucide-") ? ce(a, (function() {
                    var e = a.substring(7);
                    return ee.hasOwnProperty(e) ? ie(ee[e]) : null
                })) : Me.hasOwnProperty(a) ? ce(a, (function() {
                    var e = ne("svg", se);
                    return e.innerHTML = Me[a], e
                })) : le.hasOwnProperty(a) ? ce(a, (function() {
                    var e = ne("svg", te);
                    return e.innerHTML = le[a], e
                })) : (oe.hasOwnProperty(a) && (a = oe[a]), ee.hasOwnProperty(a) ? ce("lucide-" + a, (function() {
                    return ie(ee[a])
                })) : null)
            }(e);
            n && a.appendChild(n)
    ...
    function be(a, e) {
        if (!qa(a) && Ea(a, e)) {
            ...
            var t = a.relatedTarget;
            if (t && t.matchParent) {
                var n = t.matchParent("[aria-label]");
    ...
    function Ve(a) {
        ...
        we.has(a) && (e = we.get(a)(a));
        var t = "bottom";
        a.hasAttribute("data-tooltip-position") && (t = a.getAttribute("data-tooltip-position"));
        var n = [];
        a.hasAttribute("data-tooltip-classes") && (n = (a.getAttribute("data-tooltip-classes") || "").split(" "));
        var r, i = 1e3;
        a.hasAttribute("data-tooltip-delay") && (i = parseInt(a.getAttribute("data-tooltip-delay") || ""), isNaN(i) && (i = 1e3)), a.hasAttribute("data-tooltip-gap") && (r = ue(a.getAttribute("data-tooltip-gap"), void 0)), Ae(a, e, {
            placement: t,
            classes: n,
            delay: i,
            gap: r
    ...
    function Ae(a, e, t) {
        if (e) {
            var n = (t = t || {}).placement,
                ...
                l = t.gap,
                M = void 0 === l ? 8 : l,
                s = t.horizontalParent,
                h = t.delay,
                c = void 0 === h ? 0 : h;
            if (c > 0 && (de || Date.now() > He + 100)) return fe(), t.delay = 0, void(pe = window.setTimeout((function() {
                return Ae(a, e, t)
            }), c));
            if (a.isShown()) {
                var v = a.doc,
                ...
                de && me === a ? de.setText(e) : (Ce(), de = createDiv({
                    cls: "tooltip",
                    text: e
                }));
                var y = de.createDiv("tooltip-arrow"),
                    b = 0,
                    w = 0;
                "bottom" === r ? (b = d + f + M, w = m + p / 2) : "right" === r ? (b = d + f / 2, w = m + p + M, o.push("mod-right")) : "left" === r ? (b = d + f / 2, w = m - M, o.push("mod-left")) : "top" === r && (b = d - M - 5, w = m + p / 2, o.push("mod-top")), de.addClasses(o), de.style.top = "0px", de.style.left = "0px", de.style.width = "", de.style.height = "", de.parentNode || v.body.appendChild(de);
                var V = de.getBoundingClientRect(),
                    H = ["bottom", "top"].contains(r) ? V.width / 2 : V.width,
                    A = "right" === r || "left" === r ? V.height / 2 : V.height;
                "left" === r ? w -= H : "top" === r && (b -= A);
                var C = v.body.clientHeight,
                    k = v.body.clientWidth;
                if (b + A > C && (b = C - A - M), b = Math.max(b, M), "top" === r || "bottom" === r) {
                    if (w + H > k) w -= L = w + H + M - k, y.style.left = "initial", y.style.right = H - L - M / 2 + "px";
                    else if (w - M - H < 0) {
                        var L;
                        w += L = -(w - M - H), y.style.right = "initial", y.style.left = H - L - M / 2 + "px"
                    }
                    w = Math.max(w, M)
                }
                de.style.top = b + "px", de.style.left = w + "px", de.style.width = V.width + "px", de.style.height = V.height + "px", me = a
            }
        }
    }

    function Ce() {
        fe(), de && (He = Date.now(), de.detach(), de = null, me = null)
    }
    ...
    function ke(a, e) {
        var t = e || {},
            ...
            i = t.delay,
            o = t.gap;
        n && "bottom" !== n && a.setAttribute("data-tooltip-position", n), r && a.setAttribute("data-tooltip-classes", r.join(" ")), i && a.setAttribute("data-tooltip-delay", String(i)), o && a.setAttribute("data-tooltip-gap", String(o))
    }

    function Le(a, e, t) {
        a.setAttribute("aria-label", e), ke(a, t), me === a && Ae(a, e, t)
    }
    var ze = function() {
        return "undefined" != typeof activeWindow ? activeWindow : t.g
    };
    ...
    function Ee(a, e, t) {
        ...
        var n = null,
            ...
            s = function() {
                var e = r,
                    t = i;
                return r = null, i = null, a.apply(e, t)
            },
            h = function() {
                if (o) {
                    var a = Date.now();
                    if (a < o) return M = ze(), n = M.setTimeout(h, o - a), void(o = 0)
                }
                l = 0, n = null, s()
            },
            c = function() {
                ...
                r = this, i = a;
                var v = Date.now();
                return n ? t ? o = l = v + e : M !== ze() && l <= v && (M.clearTimeout(n), M = ze(), n = M.setTimeout(h, 0)) : (M = ze(), l = v + e, n = M.setTimeout(h, e)), c
            };
        return c.cancel = function() {
            return n && (M.clearTimeout(n), n = null), c
        }, c.run = function() {
            if (n) return M.clearTimeout(n), n = null, s()
        }, c
    }
    var xe = queueMicrotask;
    for (var Se = {
            3: "Cancel",
            6: "Help",
            8: "Backspace",
            ...
            250: "Play",
            251: "ZoomOut"
        }, De = 1; De < 25; De++) Se[111 + De] = "F" + De;
    for (De = 65; De < 91; De++) {
        var Pe = String.fromCharCode(De);
        Se[De] = Pe.toUpperCase()
    }
    for (De = 96; De < 106; De++) Se[De] = "Numpad" + String.fromCharCode(De - 48);
    var qe = function() {
            function a(a) {
            ...
            return a.prototype.register = function(a, e, t) {
                var n = {
                    scope: this,
                    modifiers: a ? Ze.compileModifiers(a) : null,
                    key: e,
                    func: t
                };
                ...
                for (var t = 0, n = this.keys; t < n.length; t++) {
                    ...
                    if (Ze.isMatch(r, e)) {
                        ...
                        if (null !== r.key || null !== r.modifiers) return i
                    }
                }
        ...
        Ze = (function(a) {
            ...
            r(e, a), e.prototype.handleKey = function(e, t) {
                var n = this.cb();
                return n ? n.handleKey(e, t) : a.prototype.handleKey.call(this, e, t)
            }
        }(qe), function() {
            function a() {
                this.windowScopes = new WeakMap, this.modifiers = "", this.rootScope = new qe, window.addEventListener("keydown", this.onKeyEvent.bind(this), !0), window.addEventListener("focusin", this.onFocusIn.bind(this))
            }
            return a.init = function() {
                ...
                var e = this.onKeyEvent.bind(this),
                    t = this.onFocusIn.bind(this);
                return a.addEventListener("keydown", e, !0), a.addEventListener("focusin", t),
                    function() {
                        a.removeEventListener("keydown", e, !0), a.removeEventListener("focusin", t)
                    }
            }, a.prototype.setWindowBaseScope = function(a, e) {
                this.getWindowStack(a).scope = e
            }, a.prototype.pushScope = function(a) {
                var e = activeWindow,
                    t = this.getWindowStack(e);
                t.scope !== a && (t.prevScopes.push(t.scope), t.scope = a, a.win = e)
            }, a.prototype.popScope = function(a) {
                if (a !== this.rootScope) {
                    var e = a.win;
                    if (e) {
                        var t = this.getWindowStack(e);
                        t.scope === a ? t.scope = t.prevScopes.pop() || this.rootScope : t.prevScopes.remove(a), a.win = null
                    }
                }
            }, a.prototype.onKeyEvent = function(e) {
                this.updateModifiers(e);
                var t = activeWindow,
                    n = this.getWindowStack(t).scope;
                if (n) {
                    var r = function(a) {
                        var e = a.key;
                        if (!e) {
                    ...
                    if (!a.isModifierKey(r)) {
                        var i = function(a) {
                            var e = a.which || a.keyCode;
                            return Se[e] || "Key" + e
                        }(e);
                        54 === e.which && "^" == e.key && "KeyI" === e.code && (i = "KeyI");
                        var o = {
                            modifiers: this.modifiers,
                            key: r,
                            vkey: i
                        };
                        return !1 === n.handleKey(e, o) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0
                    }
                }
                ...
                if (t && t.tabFocusContainerEl) {
                    var n = t.tabFocusContainerEl,
                        r = a.targetNode;
                    r && r !== activeDocument.body && r.instanceOf(Element) && !n.contains(r) && setTimeout((function() {
                        if (e.scope === t && ! function(a, e) {
                                for (var t = a.querySelectorAll(["a[href]", "button", "input", "select", "textarea", '[contenteditable]:not([contenteditable="false"])', "[tabindex]"].map((function(a) {
                                        return a + ':not([disabled]):not([tabindex="-1"])'
                                    })).join(",")), n = 0; n < t.length; n++) {
                                    var r = t[n];
                                    if (r.instanceOf(HTMLElement) && r.isShown() || r.instanceOf(SVGElement)) return r.focus(e), r
                                }
                                return null
                            }(n, {
                                preventScroll: !0
                ...
                return a.map((function(a) {
                    return "Mod" === a ? X ? "Meta" : "Ctrl" : a
                })).sort().join(",")
            }, a.decompileModifiers = function(a) {
                return a.split(",").map((function(a) {
                    return X && "Meta" === a ? "Mod" : X || "Ctrl" !== a ? a : "Mod"
                })).filter((function(a) {
                    return a
                }))
                ...
                return "Ctrl" === e ? a.ctrlKey : "Meta" === e ? a.metaKey : "Alt" === e ? a.altKey : "Shift" === e ? a.shiftKey : "Mod" === e && (X ? a.metaKey : a.ctrlKey)
            }, a.isMatch = function(a, e) {
                var t = a.modifiers,
                    n = a.key;
                return (null === t || t === e.modifiers) && (!n || (n === e.vkey || !(!e.key || n.toLowerCase() !== e.key.toLowerCase())))
    ...
    var Te = function() {
            function a(a) {
                this.submenu = null, this.checkIconEl = null, this.disabled = !1, this.checked = null, this.section = "", this.menu = a;
                var e = this.dom = createDiv("menu-item tappable");
                this.iconEl = e.createDiv("menu-item-icon"), this.titleEl = e.createDiv("menu-item-title"), e.addEventListener("click", this.handleEvent.bind(this))
            }
            return a.prototype.setTitle = function(a) {
                return "string" == typeof a ? this.titleEl.setText(a) : (this.titleEl.empty(), this.titleEl.appendChild(a)), this
            }, a.prototype.setIcon = function(a) {
                return a ? ve(this.iconEl, a) : this.iconEl.empty(), this
            }, a.prototype.removeIcon = function() {
                return this.iconEl.detach(), this
            }, a.prototype.setActive = function(a) {
                return this.setChecked(a)
            }, a.prototype.setChecked = function(a) {
                a ? this.checkIconEl || ve(this.checkIconEl = this.dom.createDiv("menu-item-icon mod-checked"), "lucide-check") : this.checkIconEl && this.checkIconEl.detach();
                return this.checked = a, this.dom.toggleClass("mod-checked", a), this
            }, a.prototype.setDisabled = function(a) {
                return this.disabled = a, this.dom.toggleClass("is-disabled", a), this
            }, a.prototype.setWarning = function(a) {
                return this.dom.toggleClass("is-warning", a), this
            }, a.prototype.setIsLabel = function(a) {
                return this.dom.toggleClass("tappable", !a), this.dom.toggleClass("is-label", a), this
            }, a.prototype.setSubmenu = function() {
                this.submenu || (this.dom.addClass("has-submenu"), this.submenu = new Be, ve(this.dom.createDiv("menu-item-icon mod-submenu"), "lucide-chevron-right"));
                return this.submenu
                ...
                if (this.disabled) e.preventDefault();
                    ...
                    var n = this,
                        ...
                        o = n.submenu;
                    if (o)
                        if (e.preventDefault(), aa.isPhone) {
                            var l = a.create(o);
                            l.setSection("title").setTitle(this.titleEl.getText()).setIcon("lucide-chevron-left").setIsLabel(!0).onClick((function(a) {
                                a.preventDefault(), Oe = t.menu, t.menu.unselect(), Aa(t.submenu.scrollEl, t.menu.scrollEl, "left"), $a(t.menu.scrollEl), t.submenu.items.remove(l)
                            })), Ka(this.menu.scrollEl), o.items.unshift(l), o.sort(), Oe = this.submenu, o.scrollEl.style.minHeight = this.menu.scrollEl.getBoundingClientRect().height + "px", Aa(this.menu.scrollEl, o.scrollEl, "right")
                        } else i.selectElement(r, !0);
                    else {
                        var M = this.callback;
                        M && M(e), this.menu.hide()
                    }
                }
            }, a.prototype.setSection = function(a) {
                return this.section = a, this.dom.setAttr("data-section", a), this
            }, a.create = function(e) {
                return new a(e)
            }, a
        }(),
        Ie = function(a) {
            this.menu = a, this.dom = createDiv("menu-separator")
        },
        Oe = null;
    var Be = function(a) {
            function e() {
                var t = a.call(this) || this;
                t.unloading = !1, t.useNativeMenu = e.useNativeMenu, t.showMacWritingTools = !1, t.items = [], t.sections = [], t.submenuConfigs = {}, t.selected = -1, t.openSubmenuSoon = Ee(t.openSubmenu.bind(t), 250, !0), t.scope = new qe(Ze.global.getRootScope());
                var n = t.dom = createDiv("menu");
                n.createDiv("menu-grabber");
                var r = t.scrollEl = n.createDiv("menu-scroll"),
                    i = t.bgEl = createDiv("suggestion-bg");
                return i.style.opacity = "0", i.addEventListener("mousedown", (function(a) {
                    return a.preventDefault()
                })), n.addEventListener("mousedown", (function(a) {
                    0 === a.button && a.preventDefault()
                })), aa.isPhone && We(n, r, i, (function() {
                    t.dom.detach(), t.hide()
                })), i.onClickEvent((function() {
                    return t.hide()
                })), t.scope.register([], "ArrowUp", t.onArrowUp.bind(t)), t.scope.register([], "ArrowDown", t.onArrowDown.bind(t)), t.scope.register([], "ArrowLeft", t.onArrowLeft.bind(t)), t.scope.register([], "ArrowRight", t.onArrowRight.bind(t)), t.scope.register([], "Enter", t.onEnter.bind(t)), t.scope.register([], "Escape", t.hide.bind(t)), n.addEventListener("pointerover", t.onPointerOver.bind(t)), t
            }
            return r(e, a), e.prototype.onload = function() {
                var a, e, t = this,
                    n = null !== (e = null === (a = this.parentEl) || void 0 === a ? void 0 : a.win) && void 0 !== e ? e : activeWindow;
                this.registerDomEvent(n, "mousedown", (function(a) {
                    var e;
                    (null === (e = t.parentEl) || void 0 === e ? void 0 : e.contains(a.targetNode)) || t.handleClickOutside(a)
                })), this.registerDomEvent(n, "click", this.handleClickOutside.bind(this)), aa.isDesktop && this.registerDomEvent(n, "contextmenu", this.hide.bind(this)), Ze.global.pushScope(this.scope)
            }, e.prototype.onunload = function() {
                Ze.global.popScope(this.scope)
            }, e.prototype.handleClickOutside = function(a) {
                if (this._loaded) {
                    var e = a.targetNode;
                    e && !this.isInside(e) && this.hide()
                }
            }, e.prototype.isInside = function(a) {
                if (this.dom.contains(a)) return !0;
                for (var e = this.parentMenu; e;) {
                    if (e.dom.contains(a)) return !0;
                    e = e.parentMenu
                }
                for (var t = this.currentSubmenu; t;) {
                    if (t.dom.contains(a)) return !0;
                    t = t.currentSubmenu
                }
                return !1
            }, e.prototype.sort = function() {
                for (var a = this, e = a.items, t = a.sections, n = a.submenuConfigs, r = {
                        "": []
                    }, i = 0, o = e; i < o.length; i++) {
                    var l = "";
                    (b = o[i]) instanceof Te && (l = b.section), "" === l || t.contains(l) || t.push(l);
                    var M = r[l];
                    r.hasOwnProperty(l) || (M = r[l] = []), M.push(b)
                }
                e = [];
                for (var s = null, h = null, c = "", v = 0, u = t; v < u.length; v++) {
                    l = u[v];
                    if (r.hasOwnProperty(l)) {
                        var d = "";
                        for (var m in n)
                            if (n.hasOwnProperty(m) && (l === m || l.substring(0, m.length + 1) === m + ".")) {
                                d = m;
                                break
                            } var p = l.split("."),
                            f = p[0],
                            g = p.length > 0 ? p.slice(1).join(".") : l;
                        if (d) {
                            if (h && d === c) h.items.push(new Ie(this));
                            else {
                                s && s.split(".")[0] !== f && (null !== s && e.push(new Ie(this)), s = l);
                                var y = n[d],
                                    b = Te.create(this);
                                e.push(b), b.setTitle(y.title), y.icon && b.setIcon(y.icon), y.disabled && b.setDisabled(!0), h = b.setSubmenu(), c = d
                            }
                            for (var w = 0, V = r[l]; w < V.length; w++) {
                                (b = V[w]) instanceof Te && b.setSection(g), h.items.push(b)
                            }
                        } else {
                            s !== f && (null !== s && e.push(new Ie(this)), s = l);
                            for (var H = 0, A = r[l]; H < A.length; H++) {
                                b = A[H];
                                e.push(b)
                            }
                        }
                ...
                if (!t.contains(""))
                    for (var C = 0, k = r[""]; C < k.length; C++) {
                        b = k[C];
                        e.push(b)
                    }
                for (; e.last() instanceof Ie;) e.pop();
                this.items = e, this.scrollEl.empty();
                for (var L = null, z = 0, E = this.items; z < E.length; z++) {
                    (b = E[z]) instanceof Te ? (L || (L = this.scrollEl.createDiv("menu-group")), L.appendChild(b.dom)) : b instanceof Ie && (L = null, this.scrollEl.appendChild(b.dom))
                }
            }, e.prototype.addSections = function(a) {
                var e = this.sections;
                a = a.filter((function(a) {
                    return !e.contains(a)
                }));
                var t = e.indexOf("");
                return -1 === t && (t = e.length), e.splice.apply(e, function(a, e, t) {
            ...
            }, e.prototype.setSectionSubmenu = function(a, e) {
                return this.submenuConfigs[a] = e, this
            }, e.prototype.setNoIcon = function() {
                return this.dom.addClass("mod-no-icon"), this
            }, e.prototype.setUseNativeMenu = function(a) {
                return this.useNativeMenu = a, this
            }, e.prototype.setShowMacWritingTools = function(a) {
                return this.showMacWritingTools = a, this
            }, e.prototype.addItem = function(a) {
                if (this._loaded) return this;
                var e = Te.create(this);
                return this.items.push(e), a(e), this
            }, e.prototype.addSeparator = function() {
                if (this._loaded) return this;
                var a = new Ie(this);
                return this.items.push(a), this
            }, e.prototype.setParentElement = function(a) {
                return this.parentEl && this.parentEl.removeClass("has-active-menu"), this.parentEl = a, this
            }, e.prototype.showAtMouseEvent = function(a) {
                return this.showAtPosition({
                    x: a.clientX,
                    y: a.clientY
                }, a.doc)
            }, e.prototype.showAtPosition = function(a, e) {
                var t = this;
                if (this.unload(), 0 === this.items.length) return this;
                var n = (e = e || activeDocument).body,
                    r = a.x,
                    i = a.y,
                    o = Xa(n.win);
                if (o) {
                    var l = o.scale;
                    r = r * l + o.x, i = i * l + o.y, n = (e = (V = o.win).document).body
                }
                if (this.parentEl && (this.parentEl.addClass("has-active-menu"), function(a, e, t, n) {
                        void 0 === n && (n = "visibility");
                        var r = a.win,
                            i = r.setInterval((function() {
                                ("visibility" === n ? !a.isShown() : !a.doc.body.contains(a)) && (r.clearInterval(i), t())
                            }), e)
                    }(this.parentEl, 500, (function() {
                        return t.hide()
                    }))), this.sort(), Ce(), !aa.isDesktop || !this.useNativeMenu) {
                    Qa.push(this, e.win), setTimeout(this.load.bind(this), 0);
                    var M, s = this.dom,
                        h = this.bgEl;
                    if (n.appendChild(s), n.appendChild(h), aa.isPhone) {
                        aa.isMobileApp && fa && fa.hide();
                        var c = s.offsetHeight - 1;
                        Ha(s, new ya({
                            duration: 150,
                            fn: "var(--anim-motion-swing)"
                        }).addProp("transform", "translateY(".concat(c, "px)"), "")), Ha(h, new ya({
                            duration: 150
                        }).addProp("opacity", "0", "0.85")), s.style.left = "", s.style.top = ""
                    } else {
                        var v = s.offsetWidth,
                            u = s.offsetHeight,
                            d = n.clientWidth,
                            ...
                            f = ue(p.paddingTop, 0) + ue(p.getPropertyValue("--safe-area-inset-top"), 0),
                            g = r,
                            y = g;
                        a.width ? a.overlap ? (g = r, y = r + a.width) : (g = r + a.width, y = r) : (g = r + 2, y = r - 2);
                        var b = s.style,
                            w = y - v >= 0;
                        !(g + v <= d) || a.left && w ? b.left = Math.max(0, y - v) + "px" : b.left = g + "px", i + u > m && (i = Math.max(f, i - u)), b.top = i + 2 + "px", (M = this.scrollEl).addEventListener("mousemove", (function(a) {
                            var e = M.clientHeight,
                                t = M.scrollHeight;
                            if (t > e) {
                                var n = (a.clientY - M.getBoundingClientRect().y - 30) / (e - 60);
                                M.scrollTop = (t - e) * Math.clamp(n, 0, 1)
                            }
                ...
                var V = e.win,
                    H = function(a) {
                        for (var e = [], t = function(a) {
                                if (a instanceof Te) {
                                    var t = {
                                        label: a.titleEl.getText().replace(/\B&\B/, "&&"),
                                        enabled: !a.disabled && !a.dom.hasClass("is-label"),
                                        checked: a.checked,
                                        type: isBoolean(a.checked) ? "checkbox" : void 0,
                                        click: function(e, t, n) {
                                            return a.handleEvent(new MouseEvent("click", n))
                                        }
                                    };
                                    a.submenu && (a.submenu.sort(), t.submenu = H(a.submenu.items)), e.push(t)
                                } else a instanceof Ie && e.push({
                                    type: "separator"
                                })
                            }, n = 0, r = a; n < r.length; n++) {
                            t(r[n])
                        }
                        return e
                    },
                    A = H(this.items),
                    C = V.electron.remote.Menu.buildFromTemplate(A);
                C.on("menu-will-close", (function() {
                    return t.hide()
                }));
                var k = V.electron.remote.getCurrentWebContents(),
                    L = Math.pow(1.2, k.getZoomLevel());
                C.popup({
                    x: Math.round(r * L),
                    y: Math.round(i * L),
                    window: V.electron.remote.getCurrentWindow(),
                    frame: this.showMacWritingTools ? k.focusedFrame : void 0
                })
            }, e.prototype.onHistoryBack = function() {
                this.hide()
            }, e.prototype.hide = function() {
                var a = this;
                if (this.unload(), this.unloading) return this;
                this.unloading = !0, Qa.pop(this), this.unselect(), this.closeSubmenu(), this.parentMenu && this.parentMenu.currentSubmenu === this ? (Oe === this && (Oe = this.parentMenu), this.parentMenu.currentSubmenu = null) : Oe = null, this.parentMenu = null, this.parentEl && (this.parentEl.removeClass("has-active-menu"), this.parentEl = null);
                var e = this,
                    t = e.dom,
                    n = e.bgEl,
                    r = e.hideCallback;
                if (this.hideCallback = null, aa.isPhone && t.isShown()) {
                    var i = t.offsetHeight - 1;
                    Ha(t, new ya({
                        duration: 150
                    }).addProp("transform", "", "translateY(".concat(i, "px)")), (function() {
                        t.detach(), r && r(), a.unloading = !1
                    })), Ha(n, new ya({
                        duration: 150
                    }).addProp("opacity", null, "0"), (function() {
                        n.detach()
                    }))
                } else t.detach(), n.detach(), r && r(), this.unloading = !1;
                return this
            }, e.prototype.close = function() {
                this.hide()
            }, e.prototype.onHide = function(a) {
                this.hideCallback = a
            }, e.prototype.onArrowUp = function(a) {
                a.preventDefault();
                for (var e = this.items, t = this.selected - 1, n = 0; n < e.length;) {
                    var r = e[t];
                    if (r && r instanceof Te && !r.disabled) return this.select(t), !1;
                    --t < 0 && (t = e.length - 1), n++
                }
                return !1
            }, e.prototype.onArrowDown = function(a) {
                a.preventDefault();
                for (var e = this.items, t = this.selected + 1, n = 0; n < e.length;) {
                    var r = e[t];
                    if (r && r instanceof Te && !r.disabled) return this.select(t), !1;
                ...
                return !1
            }, e.prototype.onArrowLeft = function(a) {
                return a.preventDefault(), this.parentMenu && this.hide(), !1
            }, e.prototype.onArrowRight = function(a) {
                a.preventDefault();
                var e = this.items[this.selected];
                return e instanceof Te && e.submenu && (this.openSubmenu(e), this.currentSubmenu && this.currentSubmenu.select(0)), !1
            }, e.prototype.onEnter = function(a) {
                var e = this.items[this.selected];
                return e && e instanceof Te && (e.handleEvent(a), this.hide()), !1
            }, e.prototype.selectElement = function(a, e) {
                void 0 === e && (e = !1);
                for (var t = this.parentMenu, n = this.items, r = 0; r < n.length; r++) {
                    var i = n[r];
                    if (i.dom.contains(a)) {
                        if (t)
                            for (var o = t.items, l = 0; l < o.length; l++) {
                                var M = o[l];
                                if (M instanceof Te && M.submenu === this) {
                                    t.selected !== l && (t.openSubmenuSoon.cancel(), t.select(l));
                                    break
                                }
                            }
                        return void(i instanceof Te && (this.select(r), e ? this.openSubmenu(i) : this.openSubmenuSoon(i)))
                    }
                }
            }, e.prototype.onPointerOver = function(a) {
                qa(a) || this.selectElement(a.targetNode, !1)
            }, e.prototype.unselect = function() {
                var a = this.items[this.selected];
                a && a.dom.removeClass("selected"), this.selected = null, this.closeSubmenu()
                ...
                if (0 !== e.length) {
                    ...
                    var n = e[t];
                    n && n.dom.removeClass("selected"), this.selected = a;
                    var r = e[a];
                    r.dom.addClass("selected"), r.dom.scrollIntoView({
                        block: "nearest"
                    })
                }
                ...
                if (!a.disabled) {
                    if (n) {
                        if (n === e || r && r.selected !== this.parentMenu.items.indexOf(a)) return;
                        this.closeSubmenu()
                    }
                    if (e) {
                        e.parentMenu = this, this.currentSubmenu = e;
                        var i = getComputedStyle(this.dom),
                            o = parseFloat(i.paddingTop) + parseFloat(i.borderTopWidth),
                            l = parseFloat(i.paddingLeft) + parseFloat(i.borderLeftWidth) + 2,
                            M = parseFloat(i.paddingRight) + parseFloat(i.borderRightWidth) + 2,
                ...
                this.openSubmenuSoon.cancel();
                var a = this.currentSubmenu;
                a && (a.hide(), a.parentMenu = null, this.currentSubmenu = null)
            }, e.forEvent = function(a) {
                a.preventDefault();
                var t = Ne.get(a);
                return t || (t = new e, Ne.set(a, t), a.win.setTimeout((function() {
                    return t.showAtMouseEvent(a)
                }))), t
            }, e.useNativeMenu = !1, e
        }(ae),
        Ne = new WeakMap;
    ...
    function We(a, e, t, n) {
        var r = function(r) {
            ...
            r.registerCallback({
                move: function(n, o) {
                    r.evt.stopPropagation(), e.style.overscrollBehavior = "none", i.addClass("hide-cursor");
                    var l = e.offsetHeight,
                        M = Math.clamp((o - r.startY) / l, 0, 1);
                    a.style.transform = "translateY(".concat(M * l, "px)"), t && (t.style.opacity = String(1 - M))
                },
                cancel: function() {
                    e.style.overscrollBehavior = "", a.style.transform = "", t && (t.style.opacity = "")
                },
                finish: function(o, l, M) {
                    e.style.overscrollBehavior = "";
                    var s, h = e.offsetHeight,
                        c = Math.clamp((l - r.startY) / h, 0, 1);
                    M < h / 2 ? (Ha(a, new ya({
                        duration: 200 * (s = c)
                    }).addProp("transform", null, "translateY(0)", ""), (function() {
                        i.removeClass("hide-cursor")
                    })), t && Ha(t, new ya({
                        duration: 150 * s,
                        fn: "linear"
                    }).addProp("opacity", null, "1", ""))) : (Ha(a, new ya({
                        duration: 100 * (s = 1 - c),
                        fn: "ease-out"
                    }).addProp("transform", null, "translateY(".concat(h, "px)"), ""), (function() {
                        n(), i.removeClass("hide-cursor")
                    })), t && Ha(t, new ya({
                        duration: 150 * s,
                        fn: "linear"
        ...
        Ya(a, (function(e) {
            1 === e.points && "y" === e.direction && (a.scrollTop > 0 || r(e))
        })), t && Ya(t, (function(a) {
            1 === a.points && "y" === a.direction && r(a)
        }))
    }
    var je = window.require;
    ...
    var Ue = "0.0.0";
    _e((function(a) {
        Ue = process.versions.electron, parseInt(Ue.split(".")[0]), aa.resourcePathPrefix = a.ipcRenderer.sendSync("file-url")
    }));
    _e((function(a) {
        try {
    ...
    var Re = '<svg aria-hidden="false" width="12" height="12" viewBox="0 0 12 12"><rect width="9" height="9" x="1.5" y="1.5" fill="none" stroke="currentColor"></rect></svg>',
        Ke = function() {
            function a(a, e) {
                var t = this;
                this.requestUpdateStatus = Ee(this.updateStatus.bind(this), 50, !0), this.eWin = a, this.win = e;
                var n = this.isMac = "darwin" === window.process.platform,
                    r = e.document,
                    i = r.body;
                i.addClass("is-frameless");
                var o = this.titleBarEl = r.createElement("div");
                o.className = "titlebar", i.insertBefore(o, i.firstChild);
                var l = this.titleBarInnerEl = o.createDiv("titlebar-inner");
                this.titleBarTextEl = l.createDiv({
                    cls: "titlebar-text",
                    text: "Obsidian"
                }), e.addEventListener("resize", this.requestUpdateStatus.bind(this));
                var M = r.head.find("title");
                M || (M = r.head.createEl("title")), new MutationObserver(this.updateTitle.bind(this)).observe(M, {
                    subtree: !0,
                    characterData: !0,
                    childList: !0
                }), this.leftButtonContainerEl = l.createDiv("titlebar-button-container mod-left");
                var s = l.createDiv("titlebar-button-container mod-right");
                if (xe((function() {
                    ...
                    if (a.minimizable) {
                        ...
                        h.innerHTML = '<svg aria-hidden="false" width="12" height="12" viewBox="0 0 12 12"><rect fill="currentColor" width="10" height="1" x="1" y="6"></rect></svg>', Ma.then((function() {
                            Le(h, va.interface.window.minimize())
                        }))
                    }
                    if (a.maximizable) {
                        var c = s.createDiv({
                        ...
                        c.innerHTML = Re;
                        var v = function() {
                            e.closed || (a.isMaximized() ? (c.innerHTML = '<svg aria-hidden="false" width="12" height="12" viewBox="0 0 12 12" fill="none"><path d="M1.5 3.5H8.5V10.5H1.5V3.5Z" stroke="currentColor"/> <path d="M4 2H10V8H9V9H11V1H3V3H4V2Z" fill="currentColor"/></svg>', Le(c, va.interface.window.restoreDown())) : (c.innerHTML = Re, Le(c, va.interface.window.maximize())))
                        };
                        Ma.then((function() {
                            v()
                    ...
                    if (a.closable) {
                        ...
                        u.innerHTML = '<svg aria-hidden="false" width="12" height="12" viewBox="0 0 12 12"> <path fill="currentColor" fill-rule="evenodd" d="M10.052 10.968 1.03 1.93l.849-.848 9.023 9.037-.849.848Z"/><path fill="currentColor" fill-rule="evenodd" d="M1.023 10.112 10.06 1.09l.848.85-9.037 9.023-.848-.85Z"/></svg>', Ma.then((function() {
                            Le(u, va.interface.window.closeWindow())
                        }))
                    }
                }! function(a) {
                    if (!aa.isMacOS || !aa.isDesktopApp) return;
                    a.addEventListener("dblclick", (function(e) {
                        if (0 === e.button) {
                            var t = e.target;
                            if (!t.instanceOf(HTMLElement) || !(t.closest(".clickable-icon") || t.closest(".workspace-tab-header-inner-close-button") || t.closest(".workspace-tab-header") && t.closest(".workspace-split.mod-sidedock"))) {
                                var n = a.win.electronWindow;
                                n.isMaximizable && _e((function(a) {
                                    var e = a.remote.systemPreferences.getUserDefault("AppleActionOnDoubleClick", "string");
                                    "Minimize" === e ? n.minimize() : "Maximize" !== e && "" !== e || (n.isMaximized() ? n.unmaximize() : n.maximize())
                                }))
                            }
                        }
                    }))
            ...
            return a.prototype.updateTitle = function() {
                ...
                var a = this.win,
                    e = this.eWin;
                if (!a.closed) {
                    var t = e.webContents.getZoomFactor(),
                        n = a.document.body;
                    if (n.toggleClass("is-fullscreen", e.isFullScreen()), n.toggleClass("is-maximized", e.isMaximized()), n.style.setProperty("--zoom-factor", String(t)), this.isMac && "native" !== a.titlebarStyle) {
                        var r = ue(getComputedStyle(n).getPropertyValue("--traffic-lights-offset-x"), 40),
                            i = ue(getComputedStyle(n).getPropertyValue("--traffic-lights-offset-y"), 40);
                        0 === i && (i = 40);
                        var o = function(a) {
                                var e = Math.floor(a * t / 2 - 8);
                                return e < -5 ? 0 : e
                            },
                            l = o(r) + 2,
                            M = o(i);
    ...
    function Xe(a, e) {
        for (var t = 0; t < e.length; t++) a[t] ^= e[t]
    }
    var Ye = function() {
        function a() {
            this.data = new Uint8Array(a.SIZE)
        }
        return a.prototype.clear = function() {
            ...
            for (var e, t, n = 0, r = a.SIZE - 1; r >= 0; r--) {
                var i = this.data[r] >>> 7 & 255;
                this.data[r] = this.data[r] << 1 | n, n = i
            }
            this.data[a.SIZE - 1] ^= (e = n, t = a.R, ~(e - 1) & t | e - 1 & 0), n = 0
        }, a.SIZE = 16, a.R = 135, a
    }();
    const Je = Ye;
    var Qe = crypto.subtle,
        at = function() {
            function a(a) {
                this.key = a
            }
            return a.importKey = function(e, t) {
                return i(this, void 0, Promise, (function() {
                    return o(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, Qe.deriveKey({
                                    name: "HKDF",
                                    salt: t,
                            ...
                            case 1:
                                return [2, new a(n.sent())]
                        }
                    }))
                }))
            }, a.prototype.encryptCtr = function(a, e) {
                return i(this, void 0, Promise, (function() {
                    var t;
                    return o(this, (function(n) {
                        switch (n.label) {
    ...
    var tt = function() {
        function a(a) {
            this._key = a, this._iv = new Je, this._emptyPromise = Promise.resolve(this)
        }
        return a.importKey = function(e, t) {
            return i(this, void 0, Promise, (function() {
                return o(this, (function(n) {
                    ...
                    switch (n.label) {
                        case 0:
                            return e = {
                                name: "AES-CBC",
                                iv: this._iv.data
                            }, [4, Qe.encrypt(e, this._key, a.data)];
                        case 1:
                            return t = n.sent(), a.data.set(new Uint8Array(t, 0, Je.SIZE)), [2, this._emptyPromise]
                    }
                }))
            }))
        }, a
    ...
    var rt = function() {
            function a(a, e, t) {
                this._cipher = a, this._subkey1 = e, this._subkey2 = t, this._bufferPos = 0, this._finished = !1, this._buffer = new Je
            }
            return a.importKey = function(e, t) {
                return i(this, void 0, Promise, (function() {
                    var n, r, i;
                    return o(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                return [4, nt.importKey(e, t)];
                            case 1:
                                return n = o.sent(), r = new Je, [4, n.encryptBlock(r)];
                            case 2:
                                return o.sent(), r.dbl(), (i = r.clone()).dbl(), [2, function() {
                                    return new a(n, r, i)
                                }]
                        }
                    }))
                    ...
                    return o(this, (function(i) {
                        switch (i.label) {
                            case 0:
                                ...
                                if (e = Je.SIZE - this._bufferPos, t = 0, !((n = a.length) > e)) return [3, 2];
                                for (r = 0; r < e; r++) this._buffer.data[this._bufferPos + r] ^= a[r];
                                return n -= e, t += e, [4, this._cipher.encryptBlock(this._buffer)];
                            case 1:
                                i.sent(), this._bufferPos = 0, i.label = 2;
                            case 2:
                                if (!(n > Je.SIZE)) return [3, 4];
                                for (r = 0; r < Je.SIZE; r++) this._buffer.data[r] ^= a[t + r];
                                return n -= Je.SIZE, t += Je.SIZE, [4, this._cipher.encryptBlock(this._buffer)];
                            case 3:
                                return i.sent(), [3, 2];
                            case 4:
                                for (r = 0; r < n; r++) this._buffer.data[this._bufferPos++] ^= a[t + r];
                                return [2, this]
                        }
                    }))
                }))
                ...
                return i(this, void 0, Promise, (function() {
                    ...
                    return o(this, (function(e) {
                        switch (e.label) {
                            case 0:
                                return this._finished ? [3, 2] : (a = this._bufferPos < Je.SIZE ? this._subkey2 : this._subkey1, Xe(this._buffer.data, a.data), this._bufferPos < Je.SIZE && (this._buffer.data[this._bufferPos] ^= 128), [4, this._cipher.encryptBlock(this._buffer)]);
                            case 1:
                                e.sent(), this._finished = !0, e.label = 2;
                            case 2:
        ...
        it = function() {
            function a(a, e) {
                this.cmacFactory = a, this._ctr = e
            }
            return a.importKey = function(e, t) {
                return i(this, void 0, Promise, (function() {
                    var n, r;
                    return o(this, (function(i) {
                        switch (i.label) {
                            case 0:
                                return [4, rt.importKey(e, t)];
                            case 1:
                                return n = i.sent(), [4, et.importKey(e, t)];
                            case 2:
                                return r = i.sent(), [2, new a(n, r)]
                        }
                    }))
                }))
            }, a.prototype.seal = function(a) {
                return i(this, void 0, Promise, (function() {
                    var e, t, n, r, i;
                    return o(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                return e = Je.SIZE + a.length, t = new Uint8Array(e), [4, this._s2v(a)];
                            case 1:
                                return n = o.sent(), t.set(n), ot(n), i = (r = t).set, [4, this._ctr.encryptCtr(n, a)];
                            case 2:
                                return i.apply(r, [o.sent(), n.length]), [2, t]
                        }
                    }))
                }))
                ...
                return i(this, void 0, Promise, (function() {
                    ...
                    return o(this, (function(i) {
                        switch (i.label) {
                            case 0:
                                if (a.length < Je.SIZE) throw new Ge("AES-SIV: ciphertext is truncated");
                                return e = a.subarray(0, Je.SIZE), (t = new Uint8Array(Je.SIZE)).set(e), ot(t), [4, this._ctr.encryptCtr(t, a.subarray(Je.SIZE))];
                            case 1:
                                return n = i.sent(), [4, this._s2v(n)];
                            case 2:
                                if (r = i.sent(), l = e, 0 === (o = r).length || 0 === l.length || 0 === function(a, e) {
                                        if (a.length !== e.length) return 0;
                                        for (var t = 0, n = 0; n < a.length; n++) t |= a[n] ^ e[n];
                                        return 1 & t - 1 >>> 8
                                    }(o, l)) throw $e(n), new Ge("AES-SIV: ciphertext verification failure!");
                                return [2, n]
                        }
                        var o, l
                    }))
                }))
            }, a.prototype._s2v = function(a) {
                return i(this, void 0, Promise, (function() {
                    var e, t, n, r, i, l;
                    return o(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                return e = this.cmacFactory(), t = new Je, n = new Je, [4, e.update(t.data)];
                            case 1:
                                return o.sent(), i = (r = n.data).set, [4, e.finish()];
                            case 2:
                                return i.apply(r, [o.sent()]), e = this.cmacFactory(), t.clear(), a.length >= Je.SIZE ? (l = a.length - Je.SIZE, t.data.set(a.subarray(l)), [4, e.update(a.subarray(0, l))]) : [3, 4];
                            case 3:
                                return o.sent(), [3, 5];
                            case 4:
                                t.data.set(a), t.data[a.length] = 128, n.dbl(), o.label = 5;
                            case 5:
                                return Xe(t.data, n.data), [4, e.update(t.data)];
                            case 6:
                                return o.sent(), [2, e.finish()]
                        }
                    }))
                }))
            }, a
    ...
    function ot(a) {
        a[a.length - 8] &= 127, a[a.length - 4] &= 127
    }
    var lt = crypto,
        Mt = null == lt ? void 0 : lt.subtle,
        st = "AES-GCM";

    function ht(a) {
        return Mt.importKey("raw", a, st, !1, ["encrypt", "decrypt"])
    }
    ...
    function ct(a, e, t) {
        return i(this, void 0, Promise, (function() {
            ...
            return o(this, (function(o) {
                switch (o.label) {
                    case 0:
                        return t || (t = lt.getRandomValues(new Uint8Array(12))), [4, Mt.encrypt({
                            name: st,
                            iv: t
                        }, e, a)];
                    case 1:
                        return n = o.sent(), r = new ArrayBuffer(t.byteLength + n.byteLength), (i = new Uint8Array(r)).set(new Uint8Array(t), 0), i.set(new Uint8Array(n), t.byteLength), [2, r]
                }
            }))
        }))
    }
    ...
    function vt(a, e) {
        return i(this, void 0, Promise, (function() {
            ...
            return o(this, (function(r) {
                switch (r.label) {
                    case 0:
                        if (a.byteLength < 12) throw new Error("Encrypted data is bad");
                        return 12 === a.byteLength ? [2, new ArrayBuffer(0)] : (t = new Uint8Array(a, 0, 12), n = new Uint8Array(a, 12), [4, Mt.decrypt({
                            name: st,
                            iv: t
                        }, e, n)]);
                    case 1:
    ...
    function dt(a) {
        return ut((new TextEncoder).encode(a))
    }
    ...
    function pt(a) {
        for (var e = a.length / 2, t = new ArrayBuffer(e), n = new Uint8Array(t), r = 0; r < e; r++) n[r] = parseInt(a.substr(2 * r, 2), 16);
        return t
    }

    function ft(a) {
        for (var e = new Uint8Array(a), t = [], n = 0; n < e.length; n++) {
            var r = e[n];
    ...
    function gt(a) {
        return i(this, void 0, Promise, (function() {
            return o(this, (function(e) {
                return [2, Mt.digest("SHA-256", new Uint8Array(a))]
            }))
        }))
    }(function() {
        function a(a, e) {
            this.encryptionVersion = 0, this.keyHash = a, this.cryptoKey = e
        }
        a.init = function(e) {
            return i(this, void 0, Promise, (function() {
                var t, n, r;
                return o(this, (function(i) {
                    switch (i.label) {
                        case 0:
                            if (32 !== e.byteLength) throw new Error("Invalid encryption key");
                            return n = ft, [4, gt(e)];
                        case 1:
                            return t = n.apply(void 0, [i.sent()]), [4, ht(e)];
                        case 2:
                            return r = i.sent(), [2, new a(t, r)]
                    }
                }))
            }))
        }, a.prototype.deterministicEncodeStr = function(a) {
            return i(this, void 0, Promise, (function() {
                var e, t, n, r;
                return o(this, (function(i) {
                    switch (i.label) {
                        case 0:
                            return [4, gt(e = dt(a))];
                        case 1:
                            return t = i.sent(), n = new Uint8Array(t, 0, 12), r = ft, [4, ct(e, this.cryptoKey, n)];
                        case 2:
                            return [2, r.apply(void 0, [i.sent()])]
                    }
                }))
            }))
        }, a.prototype.deterministicDecodeStr = function(a) {
            return i(this, void 0, Promise, (function() {
                var e, t;
                return o(this, (function(n) {
                    switch (n.label) {
                        case 0:
                            return e = pt(a), t = mt, [4, vt(e, this.cryptoKey)];
                        case 1:
            ...
            return i(this, void 0, Promise, (function() {
                return o(this, (function(e) {
                    return [2, ct(a, this.cryptoKey)]
                }))
            }))
        }, a.prototype.decrypt = function(a) {
            return i(this, void 0, Promise, (function() {
                return o(this, (function(e) {
                    return [2, vt(a, this.cryptoKey)]
                }))
            }))
        }
    })(),
    function() {
        function a(a, e, t, n) {
            if (this.keyHash = a, this.cryptoKey = e, this.siv = t, 2 !== n && 3 !== n) throw new Error("Invalid encryption version");
            this.encryptionVersion = n
        }
        a.init = function(e, t, n) {
            return i(this, void 0, Promise, (function() {
                ...
                return o(this, (function(o) {
                    switch (o.label) {
                        case 0:
                            if (32 !== e.byteLength) throw new Error("Invalid encryption key");
                            return [4, Mt.importKey("raw", e, "HKDF", !1, ["deriveKey"])];
                        case 1:
                            return r = o.sent(), i = dt(t), [4, Mt.deriveKey({
                                name: "HKDF",
                                salt: i,
                                info: dt("ObsidianKeyHash"),
                                hash: "SHA-256"
                            }, r, {
                                name: "AES-CBC",
                                length: 256
                        ...
                        case 2:
                            return l = o.sent(), s = ft, [4, Mt.exportKey("raw", l)];
                        case 3:
                            return M = s.apply(void 0, [o.sent()]), [4, it.importKey(r, i)];
                        case 4:
                            return h = o.sent(), [4, Mt.deriveKey({
                                name: "HKDF",
                                salt: new Uint8Array,
                                info: dt("ObsidianAesGcm"),
                                hash: "SHA-256"
                            }, r, {
                                name: "AES-GCM",
                                length: 256
                        ...
                        case 5:
                            return c = o.sent(), [2, new a(M, c, h, n)]
                    }
                }))
            }))
        }, a.prototype.deterministicEncodeStr = function(a) {
            return i(this, void 0, Promise, (function() {
                ...
                return o(this, (function(t) {
                    switch (t.label) {
                        case 0:
                            return e = dt(a), [4, this.siv.seal(new Uint8Array(e))];
                        case 1:
                            return [2, ft(ut(t.sent()))]
                    }
                }))
            }))
        }, a.prototype.deterministicDecodeStr = function(a) {
            return i(this, void 0, Promise, (function() {
                ...
                return o(this, (function(t) {
                    switch (t.label) {
                        case 0:
                            return e = pt(a), [4, this.siv.open(new Uint8Array(e))];
                        case 1:
                            return [2, mt(ut(t.sent()))]
                    }
                }))
            }))
        }, a.prototype.encrypt = function(a) {
    ...
    var yt = new WeakMap,
        bt = function() {
            function a(a, e) {
                void 0 === e && (e = 4e3);
                var t = this;
                this.timerId = -1, this.buttonContainerEl = null;
                var n = this.win = activeWindow,
                    r = yt.get(n);
                r || (r = createDiv("notice-container"), yt.set(n, r)), r.isShown() || n.document.body.appendChild(r);
                var i = this.containerEl = r.createDiv("notice");
                this.messageEl = this.noticeEl = i.createDiv({
                    cls: "notice-message",
                    text: a
                }), aa.isMobile ? Ha(i, (new ya).addProp("transform", "translateY(100%)", "", "")) : Ha(i, (new ya).addProp("transform", "translateX(350px)", "", "")), this.setAutoHide(e), i.addEventListener("click", (function() {
                    return t.hide()
                })), aa.isPhone && We(i, i, null, (function() {
                    i.detach(), t.hide()
                }))
            }
            return a.prototype.setMessage = function(a) {
                return this.messageEl.setText(a), this
            }, a.prototype.setAutoHide = function(a) {
                var e = this,
                    t = this.containerEl;
                if (-1 !== this.timerId && (this.win.clearTimeout(this.timerId), this.timerId = -1), a) {
                    var n = !1,
                        r = function() {
                            n || e.hide()
                        };
                    this.timerId = this.win.setTimeout(r, a), t.addEventListener("mouseenter", (function() {
                        return n = !0
                    })), t.addEventListener("mouseleave", (function() {
                        n = !1, e.win.setTimeout(r, 1e3)
                    }))
                }
                return this
            }, a.prototype.addButton = function(a, e) {
                var t = this;
                return this.buttonContainerEl || (this.buttonContainerEl = this.containerEl.createDiv("notice-button-container")), this.buttonContainerEl.createDiv({
                    cls: "notice-cta",
                    text: a
                ...
                var a = this,
                    ...
                    t = e.containerEl,
                    n = e.win,
                    r = e.timerId; - 1 != r && (n.clearTimeout(r), r = -1);
                var i = function() {
                    t.detach();
                    var e = yt.get(a.win);
                    e && 0 === e.childElementCount && e.detach()
                };
                if (t.isShown())
                    if (aa.isMobile) Ha(t, new ya({
                        duration: 150
                    }).addProp("transform", "scale(1, 1)", "scale(0.85, 0.85)", "").addProp("opacity", "1", "0", ""), i);
                    else {
                        var o = getComputedStyle(t),
                            l = -t.offsetHeight,
                            M = parseInt(o.marginBottom);
                        isNaN(M) || (l -= M), Ha(t, new ya({
                            duration: 120
                        }).addProp("opacity", "1", "0").addProp("margin-top", "0px", l + "px"), i)
                    }
                else i()
            }, a
        }();
    window.Notice = bt;
    var wt = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})?$/i;
    ...
    function Ht(a) {
        var e, t, n, r = a.h,
            i = a.s,
            o = a.l;
        if (r /= 360, o /= 100, 0 == (i /= 100)) e = t = n = o;
        else {
            var l = o < .5 ? o * (1 + i) : o + i - o * i,
                M = 2 * o - l;
            e = Vt(M, l, r + 1 / 3), t = Vt(M, l, r), n = Vt(M, l, r - 1 / 3)
        }
        return {
            r: Math.round(255 * e),
            g: Math.round(255 * t),
    ...
    var kt, Lt = function() {
            function a(a) {
                ...
                var e = this.settingEl = a.createDiv({
                    ...
                    t = this.infoEl = e.createDiv("setting-item-info");
            ...
            return a.prototype.setErrorMessage = function(a) {
                ...
                return a(new Pt(this.controlEl)), this
            }, a.prototype.setIcon = function(a) {
                return this.iconEl || (this.iconEl = this.settingEl.createDiv({
                    cls: "setting-item-icon",
                    prepend: !0
                })), a ? ve(this.iconEl, a) : this.iconEl.empty(), this
                ...
                return Le(this.nameEl, a, e), this
                ...
                this.rowClick || this.settingEl.addEventListener("click", (function(a) {
                    var t;
                    a.defaultPrevented || e.disabled || null === (t = e.rowClick) || void 0 === t || t.call(e)
                })), this.rowClick = a
            }, a
        }(),
        zt = function() {
            function a(a) {
                ...
                var e = this.groupEl = a.createDiv("setting-group"),
                    t = this.headerEl = createDiv("setting-item setting-item-heading");
                this.headerInnerEl = t.createDiv("setting-item-name"), this.controlEl = t.createDiv("setting-item-control"), this.searchContainerEl = e.createDiv({
            ...
            return a.prototype.setHeading = function(a) {
                ...
                var e = !!a || this.controlEl.childElementCount > 0,
                    t = this.headerEl.isShown();
                return e && !t ? this.groupEl.prepend(this.headerEl) : !e && t && this.headerEl.detach(), this
                ...
                var e = new Lt(this.listEl);
                return this.settings.push(e), a(e), this
            }, a.prototype.addSearch = function(a) {
                var e = new It(this.searchContainerEl);
                return this.components.push(e), a(e), this
                ...
                var e = this;
                return this.listEl.addEventListener("keydown", (function(t) {
                    if (!(t.isComposing || t.defaultPrevented || "Delete" !== t.key && "Backspace" !== t.key)) {
                        var n = t.target;
                        if (n.hasClass("setting-item")) {
                            var r = e.settings.findIndex((function(a) {
                                return a.settingEl === n
                            }));
                            r < 0 || (t.preventDefault(), a(r), e.listEl.isConnected && e.focusNearestItem(r))
                        }
                    }
                })), this
                ...
                var e = this;
                return this.listEl.addEventListener("keydown", (function(t) {
                    if (!t.isComposing && !t.defaultPrevented && t.altKey && ("ArrowUp" === t.key || "ArrowDown" === t.key)) {
                        var n = t.target;
                        if (n.hasClass("setting-item")) {
                            var r = e.settings.findIndex((function(a) {
                                return a.settingEl === n
                            ...
                            if (!(r < 0)) {
                                t.preventDefault();
                                var i = "ArrowUp" === t.key ? -1 : 1,
                                    o = Math.clamp(r + i, 0, e.settings.length - 1);
                                o !== r && a(r, o)
                            }
                        }
                    }
        ...
        xt = function(a) {
            ...
            return r(e, a), e.prototype.registerOptionListener = function(a, e) {
                var t = this;
        ...
        St = function(a) {
            function e(e) {
                var t = a.call(this) || this,
                    n = t.buttonEl = e.createEl("button");
                return n.addEventListener("click", (function(a) {
                        ...
                        return o(this, (function(t) {
                            switch (t.label) {
                                case 0:
                                    ...
                                    n.addClass("mod-loading"), t.label = 1;
                                case 1:
                                    return t.trys.push([1, , 3, 4]), [4, e(a)];
                                case 2:
                                    return t.sent(), [3, 4];
                                case 3:
                                    return n.removeClass("mod-loading"), [7];
                                case 4:
                                    return [2]
                            }
                        }))
            ...
            return r(e, a), e.prototype.setDisabled = function(e) {
        ...
        Dt = function(a) {
            function e(e) {
                var t = a.call(this) || this,
                    n = t.extraSettingsEl = e.createDiv({
                        cls: "clickable-icon extra-setting-button",
                        attr: {
                            tabIndex: 0
                        }
                    });
                ve(n, "lucide-settings");
                var r = function() {
            ...
            return r(e, a), e.prototype.setDisabled = function(e) {
                ...
                return Le(this.extraSettingsEl, a, e), this
            }, e.prototype.setIcon = function(a) {
                return ve(this.extraSettingsEl, a), this
            }, e.prototype.onClick = function(a) {
        ...
        Pt = function() {
            ...
            return a.prototype.setValue = function(a) {
                ...
                var e;
                return a ? (this.statusEl || (this.statusEl = createDiv("setting-item-status"), this.valueEl.after(this.statusEl)), "warning" === a && (this.statusEl.addClass("mod-warning"), ve(this.statusEl, "lucide-alert-triangle")), this) : (null === (e = this.statusEl) || void 0 === e || e.detach(), this.statusEl = null, this)
            }, a
        }(),
        qt = function(a) {
            function e(e) {
                var t = a.call(this) || this;
                return t.on = !1, t.toggleEl = e.createEl("label", {
                    ...
                    }), a.addEventListener("change", t.onClick.bind(t)), a.addEventListener("keydown", (function(a) {
                        " " !== a.key && "Enter" !== a.key || (a.preventDefault(), t.onClick())
                    }))
                })), t
            }
            return r(e, a), e.prototype.setDisabled = function(e) {
                ...
                return Le(this.toggleEl, a, e), this
        ...
        Tt = function(a) {
            function e(e) {
                var t = e.createEl("input", {
                    type: "text"
                });
                return a.call(this, t) || this
            }
            return r(e, a), e.prototype.autoSelect = function(a) {
                return void 0 === a && (a = !1), Ta(this.inputEl, a), this
            }, e
        }(Zt),
        It = function(a) {
            function e(e) {
                var t = this,
                    n = e.createDiv("search-input-container"),
                    r = n.createEl("input", {
                        type: "search",
                        attr: {
                            enterkeyhint: "search"
                ...
                return (t = a.call(this, r) || this).containerEl = n, t.clearButtonEl = n.createDiv("search-input-clear-button", (function(a) {
                    a.addEventListener("mousedown", (function(a) {
                        return a.preventDefault()
                    })), a.addEventListener("click", (function() {
                        t.disabled || (r.value = "", t.onChanged(), r.focus())
                    }))
                })), t
            }
            return r(e, a), e.prototype.onChanged = function() {
        ...
        Bt = (function(a) {
            function e(e) {
                ...
                return t.inputEl.setAttribute("type", "number"), t
            }
            r(e, a), e.prototype.getValueAsNumber = function() {
                return this.inputEl.valueAsNumber
            }, e.prototype.setValueAsNumber = function(a) {
                return this.inputEl.valueAsNumber = a, this
            }, e.prototype.setLimits = function(a, e, t) {
            ...
            return r(e, a), e.prototype.setDefaultFormat = function(a) {
        ...
        Nt = function(a) {
            function e(e) {
                var t = a.call(this) || this;
                return t.selectEl = e.createEl("select", "dropdown"), t.measureEl = e.createEl("select", "dropdown is-measuring"), t.measureEl.setAttribute("aria-hidden", "true"), t.measureEl.tabIndex = -1, t.measureOptionEl = t.measureEl.createEl("option"), t.selectEl.onNodeInserted((function() {
                    return t.resizeToFit()
                }), !0), t.selectEl.addEventListener("change", (function() {
                    t.resizeToFit();
                    var a = t.changeCallback;
                    a && a(t.getValue())
                })), t.selectEl.addEventListener("mousedown", (function() {
                    t.selectEl.addClass("mouse-focus")
                })), t.selectEl.addEventListener("blur", (function() {
                    t.selectEl.removeClass("mouse-focus")
                })), t
            }
            return r(e, a), e.prototype.resizeToFit = function() {
                var a = this,
                    e = a.selectEl,
                    t = a.measureEl,
                    n = a.measureOptionEl,
                    r = e.options[e.selectedIndex];
                r && (n.text = r.text, e.style.setProperty("--dropdown-fitted-width", t.offsetWidth + "px"))
        ...
        Wt = function(a) {
            ...
            return r(e, a), e.prototype.getValue = function() {
                return this.value
            }, e.prototype.setValue = function(a) {
        ...
        jt = function(a) {
            function e(e) {
                var t = a.call(this) || this;
                t.displayFormat = null, t.changeCallback = null, t.instant = !1, t.valueEl = e.createEl("span", "slider-value");
                var n = t.sliderEl = e.createEl("input", {
                    type: "range",
                    cls: "slider"
                });
                return n.dataset.ignoreSwipe = "true", n.addEventListener("input", (function() {
                    if (navigator.vibrate(100), t.updateDisplay(), t.instant) {
                        var a = t.changeCallback;
                        a && a(t.getValue())
                    }
            ...
            return r(e, a), e.prototype.setDisabled = function(e) {
                ...
                var a = this.sliderEl,
                    ...
                    t = this.getValue();
                return e ? e(t) : "any" === a.step || parseFloat(a.step) < 1 ? t.toFixed(2) : t.toString()
        ...
        Ft = function(a) {
            function e(e) {
                ...
                return t.colorPickerEl = e.createEl("input", {
                    type: "color"
                }), t.colorPickerEl.addEventListener("change", (function() {
                    var a = t.changeCallback;
                    a && a(t.getValue())
                })), t
            }
            return r(e, a), e.prototype.setDisabled = function(e) {
                ...
                return this.setValue(function(a) {
                    var e = a.r,
                        t = a.g,
                        n = a.b;
                    return "#" + At(e) + At(t) + At(n)
                }(a))
            }, e.prototype.setValueHsl = function(a) {
                return this.setValueRgb(Ht(a))
    ...
    ! function(a) {
        ...
        if (t) {
            var n = t("electron");
            if (n) {
                if (a.electron = n, !n.remote) try {
                    n.remote = t("@electron/remote")
                } catch (a) {
                    console.error(a)
                }
                a.electronWindow = n.remote.getCurrentWindow();
                var r = a.open;
                a.open = function(a, e, t) {
                    return "string" == typeof a && 0 === a.indexOf("file:") ? (n.ipcRenderer.send("open-url", a), null) : r.apply(this, arguments)
                }, a.parent === a && function(a) {
                    var e = a.electron.ipcRenderer.sendSync("frame") || "hidden";
                    a.titlebarStyle = e, "native" !== e && (a.frameDom = new Ke(a.electronWindow, a), "hidden" === e && a.document.body.addClass("is-hidden-frameless"))
                }(a)
            }
        }
    }(window), kt = electron.ipcRenderer.sendSync("policy"), da || (ua = Object.freeze(kt), da = !0),
        function(a) {
            a || (a = document);
            var e = a.body;
            e.on("pointerover", "[aria-label]", ye), e.on("pointerout", "[aria-label]", be), e.addEventListener("pointerup", Ce)
        }(),
        function(a) {
            try {
                var e = "";
                X ? e = "mod-macos" : Y ? e = "mod-windows" : J && (e = "mod-linux"), e && a.body.addClass(e)
            } catch (a) {
                console.error(a)
            }
        }(document);
    ...
    ready((function() {
        return i(void 0, void 0, void 0, (function() {
            function a(a, e) {
                var t = M.dialog.showOpenDialogSync({
                    title: a,
            ...
            function e() {
                var t = this,
                    n = h.sendSync("vault-list"),
                    r = Object.keys(n).length > 0;
                for (var M in y.empty(), g.toggle(r), A.toggle(!r), n) n.hasOwnProperty(M) && (n[M].id = M);
                var s = Object.values(n);
                s.sort((function(a, e) {
                    return e.ts - a.ts
                }));
                for (var c = function(n) {
                        var r = y.createDiv("recent-vaults-list-item"),
                            M = v.basename(n.path),
                            s = v.dirname(n.path),
                            c = r.createDiv({
                        ...
                        var d = function(a, r) {
                                return i(t, void 0, void 0, (function() {
                                    var t, i;
                                    return o(this, (function(o) {
                                        return a === n.path ? [2] : u.existsSync(a) ? (new bt(l("msg-error-".concat(r, "-exists"))), [2]) : !(t = v.relative(n.path, a)) || t.startsWith("..") || v.isAbsolute(t) ? (i = h.sendSync("vault-move", n.path, a), new bt("EVAULTOPEN" === i ? l("msg-error-".concat(r, "-open")) : i ? l("msg-".concat(r, "-failed")) + " " + i : l("msg-".concat(r, "-success"))), e(), [2]) : (new bt(l.msgErrorNested()), [2])
                                    }))
                                }))
                            },
                            m = function() {
                                c.contentEditable = "true", c.tabIndex = -1, Za(c);
                                var a = function() {
                                        t(), n(), c.setText(M)
                                    },
                                    e = function(a) {
                                        a.isComposing || "Enter" !== a.key && "Escape" !== a.key || (t(), "Enter" === a.key && n(), c.setText(M))
                                    },
                                    t = function() {
                                        c.removeAttribute("contenteditable"), c.removeAttribute("tabindex"), c.removeEventListener("blur", a), c.removeEventListener("keydown", e)
                                    },
                                    n = function() {
                                        var a = c.innerText;
                                        d(v.join(s, a), "rename")
                                    };
                                c.addEventListener("blur", a), c.addEventListener("keydown", e), c.addEventListener("click", (function(a) {
                                    a.preventDefault()
                                }))
                            },
                            p = function(t) {
                                t.preventDefault(), r.hasClass("has-active-menu") || Be.forEvent(t).setParentElement(r).addSections(["open", "info", "action", "system", "", "danger"]).addItem((function(a) {
                                    return a.setIcon("lucide-edit-3").setSection("action").setTitle(l.optionRenameVault()).onClick(m)
                                })).addItem((function(e) {
                                    return e.setIcon("lucide-folder-tree").setSection("action").setTitle(l.optionMoveVault()).onClick((function() {
                                        var e = a(l.msgMoveSelectDest(), s);
                                        e && d(v.join(e, M), "move")
                                    }))
                                })).addItem((function(a) {
                                    return a.setIcon("lucide-copy").setTitle(l.optionCopyVaultID()).setSection("info").onClick((function() {
                                        navigator.clipboard.writeText(n.id), new bt(va.interface.copied_generic())
                                    }))
                                })).addItem((function(a) {
                                    return a.setIcon("lucide-folder-open").setTitle(aa.isMacOS ? l.optionRevealVaultInExplorerMac() : l.optionRevealVaultInExplorer()).setSection("system").onClick((function() {
                                        var a;
                                        a = n.path, window.electron && electron.remote.shell.showItemInFolder(a)
                                    }))
                                })).addItem((function(a) {
                                    return a.setIcon("lucide-x").setTitle(l.optionRemove()).setSection("danger").setWarning(!0).onClick((function() {
                                        h.sendSync("vault-remove", n.path) ? function(a) {
                                            try {
                                                indexedDB.databases().then((function(e) {
                                                    for (var t = 0, n = e; t < n.length; t++) {
                                                        var r = n[t];
                                                        r.name.startsWith(a + "-") && x(r.name)
                                                    }
                                                }))
                                            } catch (a) {}
                                            try {
                                        ...
                                        }(n.id) : new bt(l.msgErrorRemoveCurrentOpenVault()), e()
                                    }))
                                }))
                            };
                        r.addEventListener("contextmenu", (function(a) {
                            return p(a)
                        })), r.createDiv("recent-vaults-list-item-option-button", (function(a) {
                            ve(a, "lucide-more-vertical"), Le(a, va.interface.menu.moreOptions()), a.addEventListener("click", (function(a) {
                                return p(a)
                            }))
                        })), r.addEventListener("click", (function(a) {
                            if (!a.defaultPrevented) {
                                a.preventDefault();
                                var e = h.sendSync("vault-open", n.path, !1);
                                !0 === e ? window.close() : new bt("".concat(l.msgErrorFailedToOpenVault(), " ").concat(e, "."))
                            }
                        })), Le(r, n.path, {
                            placement: "right"
                        })
                    }, d = 0, m = s; d < m.length; d++) {
                    c(m[d])
                }
            }
            ...
            function t() {
                ...
                $.empty(),
                    function(a) {
                        for (var e = createDiv("loader-cube"), t = 1; t <= 9; t++) e.createDiv({
                            cls: "sk-cube sk-cube".concat(t)
                        });
                        a && a.appendChild(e)
                    }($), za(V, $, "right", (function() {
                            ...
                            return o(this, (function(n) {
                                switch (n.label) {
                                    case 0:
                                        a = [], n.label = 1;
                                    case 1:
                                        return n.trys.push([1, 3, , 4]), [4, (r = f.token, i = 3, c("/vault/list", {
                                            token: r,
                                            supported_encryption_version: i
                                        }))];
                                    case 2:
                                        return e = n.sent(), a = e.vaults.concat(e.shared), [3, 4];
                                    case 3:
                                        return t = n.sent(), new bt(t.message), [3, 4];
                                    case 4:
                                        return X(a), [2]
                                }
                                var r, i
                ...
                switch (c.label) {
                    ...
                    case 1:
                        return c.sent(), aa.isDesktop = !0, aa.hasPhysicalKeyboard = !0, aa.isDesktopApp = !0, document.body.addClass("is-focused"), n = va.plugins.sync, r = va.setting.account, l = va.interface.startScreen, M = electron.remote, h = electron.ipcRenderer, setTimeout((function() {
                                ...
                                text: "".concat(l.labelVersion(), " ").concat(h.sendSync("version"))
                            }), V = b.createDiv("open-vault-options-container"), H = V.createDiv("open-vault-options mod-open-vault"), A = H.createDiv("quick-start-container u-center-text"), new St(A).setCta().setButtonText(l.buttonQuickStart()).onClick((function() {
                                var a = h.sendSync("get-default-vault-path"),
                                    e = h.sendSync("vault-open", a, !0);
                                !0 === e ? h.sendSync("vault-message", a, {
                                    action: "vault-setup"
                                }) : e = h.sendSync("vault-open", a, !1), !0 === e ? window.close() : new bt("".concat(l.msgErrorFailedToOpenVault(), " ").concat(e, "."))
                            })), C = oa(), new zt(H).addSetting((function(a) {
                                return a.setName(l.optionCreateVault()).setDesc(l.optionCreateVaultDescription()).addButton((function(a) {
                                    return a.setButtonText(l.buttonCreateVault()).setCta().onClick((function() {
                                        z = null, E = H, q.setHeading(l.labelCreateLocalVault()), za(V, S, "right")
                                    }))
                                }))
                            })).addSetting((function(e) {
                                return e.setName(l.optionOpenFolderAsVault()).setDesc(l.optionOpenFolderAsVaultDescription()).addButton((function(e) {
                                    return e.setButtonText(l.buttonOpen()).onClick((function() {
                                        var e = a(l.optionOpenFolderAsVault());
                                        if (e) {
                                            var t = h.sendSync("vault-open", e, !1);
                                            !0 === t ? window.close() : new bt("".concat(l.msgErrorFailedToOpenVault(), " ").concat(t, "."))
                                        }
                                    }))
                                }))
                            })).addSetting((function(a) {
                                ua.sync ? (a.setName(l.optionConnectObsidianSync()).setDesc(l.optionConnectObsidianSyncDescription()), f.email && f.token ? a.addButton((function(a) {
                                    return a.setButtonText(l.buttonSetup()).onClick((function() {
                                        return t()
                                    }))
                                })) : a.addButton((function(a) {
                                    return a.setButtonText(l.buttonSignIn()).onClick((function() {
                                        za(V, T, "right")
                                    }))
                                }))) : a.settingEl.hide()
                            })).addSetting((function(a) {
                                a.addDropdown((function(a) {
                                    for (var e = 0, t = _; e < t.length; e++) {
                                        var n = t[e];
                                        a.addOption(n, F[n])
                                    }
                                    a.setValue(C), a.onChange((function(a) {
                                        var e, t;
                                        (t = (e = a) === ta && la() === ta) ? localStorage.removeItem(ea): localStorage.setItem(ea, e), aa.isDesktopApp && electron.ipcRenderer.sendSync("set-language", t ? null : e), window.location.reload()
                                    }))
                                })), ve(a.nameEl, "help"), Le(a.nameEl, l.optionGetHelp()), a.nameEl.addEventListener("click", (function() {
                                    h.sendSync("help")
                                })), a.setClass("mod-change-language")
                            })), L = "", z = null, E = H, (S = createDiv("open-vault-options mod-create-vault")).createDiv({
                                cls: "back-button"
                            }, (function(a) {
                                ve(a, "lucide-arrow-left"), a.appendText(l.buttonBack()), a.addEventListener("click", (function() {
                                    za(V, E, "left")
                                }))
                            })), q = new zt(S).addSetting((function(a) {
                                return a.setName(l.optionNewVaultName()).setDesc(l.optionNewVaultNameDescription()).addText((function(a) {
                                    return a.setPlaceholder(l.optionNewVaultName()).then((function(a) {
                                        return k = a
                                    }))
                                }))
                            })).addSetting((function(e) {
                                D = e.setName(l.optionNewVaultLocation()).setDesc(l.optionNewVaultLocationDescription()).addButton((function(e) {
                                    return e.setButtonText(l.buttonBrowse()).onClick((function() {
                                        var e = a(l.optionNewVaultLocation());
                                        e && Z(e)
                                    }))
                                }))
                            })).addSetting((function(a) {
                                P = a, a.settingEl.hide()
                            })), Z = function(a) {
                                L = a, D.setDesc(createFragment((function(e) {
                                    e.appendText(l.labelNewVaultLocationPreview()), e.createSpan({
                                        cls: "u-pop",
                                        text: a
                                    });
                                    var t = a.toLowerCase(),
                                        r = "";
                                    if (t.contains("dropbox") ? r = "Dropbox" : t.contains("com~apple~clouddocs") || t.contains("icloud~") ? r = "iCloud" : t.contains("onedrive") && (r = "OneDrive"), P.settingEl.hide(), r) P.settingEl.show(), P.setName(n.labelThirdPartySyncWarning()), P.setDesc(n.labelThirdPartySyncWarningDesc({
                                        service: r
                                    }));
                                    else if (aa.isMacOS) {
                                        var i = electron.ipcRenderer.sendSync("documents-dir").toLowerCase(),
                                            o = electron.ipcRenderer.sendSync("desktop-dir").toLowerCase();
                                        (t.startsWith(i) || t.startsWith(o)) && (P.settingEl.show(), P.setName(""), P.setDesc(n.labelIcloudDriveWarning()))
                                    }
                                })))
                            }, S.createDiv("button-container", (function(a) {
                                a.createEl("button", {
                                    cls: "mod-cta",
                                    text: l.buttonCreateVault()
                                }, (function(a) {
                                    a.addEventListener("click", (function() {
                                        var a = k.getValue().trim();
                                        if (a)
                                            if (aa.isWin && a.endsWith(".")) new bt(l.msgTrailingDotVaultName());
                                            else if (L) {
                                            var e = L + "/" + a;
                                            try {
                                                var t = h.sendSync("vault-open", e, !0);
                                                if (!0 === t) return z ? (h.sendSync("vault-message", e, {
                                                    action: "sync-setup",
                                                    vault: JSON.stringify(z)
                                                }), za(V, H, "left")) : h.sendSync("vault-message", e, {
                                                    action: "vault-setup"
                                                }), void window.close();
                                                new bt("".concat(l.msgFailedToCreateVault(), " ").concat(t, "."))
                                            } catch (a) {
                                                console.error(a), new bt(l.msgFailedToCreateVaultAtLocation())
                                            }
                                        } else new bt(l.msgInvalidFolder());
                                        else new bt(l.msgEmptyVaultName())
                                    }))
                                }))
                            })), (T = createDiv("open-vault-options mod-login")).createDiv({
                                cls: "back-button"
                            }, (function(a) {
                                ve(a, "lucide-arrow-left"), a.appendText(l.buttonBack()), a.addEventListener("click", (function() {
                                    za(V, H, "left")
                                }))
                            })), I = T.createDiv("message-container", (function(a) {
                                O = a.createDiv("message mod-error")
                            })), U = function(a) {
                                O.setText(a), I.show()
                            },
                            function() {
                                O.setText(""), I.hide()
                            }(), new zt(T).addSetting((function(a) {
                                R = a.setName(l.optionUserEmail()).addText((function(a) {
                                    return a.setPlaceholder(l.placeholderYourEmail()).then((function(a) {
                                        return B = a
                                    }))
                                }))
                            })).addSetting((function(a) {
                                K = a.setName(l.optionUserPassword()).addText((function(a) {
                                    return a.setPlaceholder(l.placeholderYourPassword()).then((function(a) {
                                        N = a, a.inputEl.setAttribute("type", "password")
                                    }))
                                }))
                            })).addSetting((function(a) {
                                G = a.setName(r.labelMfaCode()).addText((function(a) {
                                    W = a, a.inputEl.setAttribute("maxlength", "6"), a.inputEl.inputMode = "numeric"
                                })), a.settingEl.hide()
                            })).addSetting((function(a) {
                                return a.addButton((function(a) {
                                    return a.setButtonText(l.buttonSignIn()).setCta().onClick((function() {
                                        return i(void 0, void 0, void 0, (function() {
                                            var a, e, n, i, l;
                                            return o(this, (function(o) {
                                                switch (o.label) {
                                                    case 0:
                                                        if (a = B.getValue(), e = N.getValue(), n = W.getValue(), "" === a) return U(r.messageEmptyEmail()), [2];
                                                        if (!a.contains("@")) return U(r.messageInvalidEmail()), [2];
                                                        if ("" === e) return U(r.messageEmptyPassword()), [2];
                                                        if ("" !== n && !/^\d{6}$/.test(n)) return U(r.mfaWrongFormat()), [2];
                                                        o.label = 1;
                                                    case 1:
                                                        return o.trys.push([1, 3, , 4]), [4, f.login(a, e, n)];
                                                    case 2:
                                                        return o.sent(), [3, 4];
                                                    case 3:
                                                        return (i = o.sent()) instanceof s ? (l = i.error).contains("2FA code is incorrect") ? U(r.mfaVerificationFailed()) : l.contains("2FA code") ? (R.settingEl.hide(), K.settingEl.hide(), G.settingEl.show()) : U(l) : U(i.message), [2];
                                                    case 4:
                                                        return t(), [2]
                                                }
                                            }))
                            ...
                            })), $ = createDiv("open-vault-options"), X = function(a) {
                                if ($.empty(), $.createDiv({
                                        cls: "back-button"
                                    }, (function(a) {
                                        ve(a, "lucide-arrow-left"), a.appendText(l.buttonBack()), a.addEventListener("click", (function() {
                                    ...
                                    })), 0 === a.length) $.createEl("p", {
                                    text: n.labelNotRemoteVaults()
                                });
                                else
                                    for (var e = new zt($), t = function(a) {
                                            e.addSetting((function(e) {
                                                var t = createDiv("setting-icon", (function(e) {
                                                    "share_uid" in a && a.share_uid ? (ve(e, "lucide-users"), Le(e, l.tooltipSharedVault())) : (ve(e, "vault"), Le(e, l.tooltipOwnVault()))
                                                }));
                                                e.setName(a.name).setDesc(l.optionConnectVaultDesc()).addButton((function(e) {
                                                    return e.setButtonText(l.buttonConnect()).onClick((function() {
                                                        k.setValue(a.name), q.setHeading('Create synced local vault for "'.concat(a.name, '"')), E = $, Z(h.sendSync("get-documents-path")), z = a, za(V, S, "right")
                                                    }))
                                                })).settingEl.prepend(t)
                                            }))
                            ...
                            }, Y = createDiv("open-vault-options"), new zt(Y).addSetting((function(a) {
                                return a.setName(l.optionNewVaultName()).setDesc(l.optionNewVaultNameDescription())
                            })), e(),
                            function() {
                                i(this, void 0, void 0, (function() {
                                    ...
                                    return o(this, (function(o) {
                                        switch (o.label) {
                                            case 0:
                                                return a = h.sendSync("vault-list"), [4, indexedDB.databases()];
                                            case 1:
                                                e = o.sent(), t = 0, n = e, o.label = 2;
                                            case 2:
                                                return t < n.length ? (r = n[t]).name && r.name.endsWith("-browser") ? (i = r.name.slice(0, -8), a[i] ? [3, 4] : [4, indexedDB.deleteDatabase(r.name)]) : [3, 4] : [3, 5];
                                            case 3:
                                                o.sent(), o.label = 4;
                                            case 4:
                                                return t++, [3, 2];
